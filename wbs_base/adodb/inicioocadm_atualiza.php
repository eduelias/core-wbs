...
<input name='aport[$i]' type='text' id='aport[$i]' size='4' maxlength='4' value = '$xaport'/></td>
     ...
     <tr>
       <td bgcolor='#FFFFCC'><font size='1' face='Verdana, Arial, Helvetica, sans-serif'>NF:</font></td>
       <td><font face='Verdana, Arial, Helvetica, sans-serif'>
         <input name='nf_fab[$i]' type='text' id='nf_fab[$i]' value='$xnf_fab' size='6' maxlength='6' />
       </font></td>
       <td bgcolor='#FFFFCC'><font size='1' face='Verdana, Arial, Helvetica, sans-serif'>DATA NF:</font></td>
       <td><input name='dnf[$i]' type='text' id='dnf[$i]' size='2' maxlength='2' value = '$xdnf'/>
/
<input name='mnf[$i]' type='text' id='mnf[$i]' size='2' maxlength='2' value = '$xmnf'/>
/
<input name='anf[$i]' type='text' id='anf[$i]' size='4' maxlength='4' value = '$xanf'/></td>
     </tr>
     <tr>
       <td bgcolor='#FFFFCC'><font size='1' face='Verdana, Arial, Helvetica, sans-serif'>OBS:</font></td>
       <td><font face='Verdana, Arial, Helvetica, sans-serif'>
         <input name='obs_fab[$i]' type='text' id='obs_fab[$i]' value='$obs_fab' size='50' maxlength='200' />
       </font></td>
