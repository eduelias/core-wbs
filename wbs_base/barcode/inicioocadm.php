...
<input name='aport[$i]' type='text' id='aport[$i]' size='4' maxlength='4' value = '$xaport'/></td>
     ...
     <tr>
       ...
       <td colspan="3"><font face='Verdana, Arial, Helvetica, sans-serif'>
         <input name='nf_fab[$i]' type='text' id='nf_fab[$i]' value='$xnf_fab' size='100' maxlength='100' /><br><font color='#FF0000' size='-6'>ex: 278977 de 12/04/2007 368726 de 03/06/2006</font>
       </font></td>
     </tr>
     <tr>
