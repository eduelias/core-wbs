...
if (count($array) <> 0){
	 ...
	 for($i = 0; $i < count($array); $i++ ){
			...
			$prod->listProdSum("codbarra, flag_acerto", "codbarra", "codprod = $codprod and codemp=$codempselect and codbarraped <> 1", $array1, $array_campo1, "" );
...
if ($flag_acerto <> 'N'){
echo("
<font face='Verdana' size='1' color = '#FF0000'>$codbarra</font>
...
");
 ...
 echo("	
		  ...
		  <td align='center' width='5%' height='0' bgcolor='#F7BBC4'> 
      <div align='center'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>$est_real</font></b></div>
		  </td>
		 <td align='center' width='5%' height='0' bgcolor='#C7E3C6'> 
