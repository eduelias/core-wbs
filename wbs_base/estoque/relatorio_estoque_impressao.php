...
");
		...
		for($i = 0; $i < count($array); $i++ ){
			...
			*/
			...
			// VERIFICA QUANTIDADES COMPRADAS DESSE PRODUTO
			$prod->listProdU("COUNT(*)", "codbarra", "codprod = $codprod and codemp=$codempselect and codbarraped  <> 0");
			...
			*/
			...
			$prod->listProdSum("codbarra", "codbarra", "codprod = $codprod and codemp=$codempselect and codbarraped <> 1", $array1, $array_campo1, "" );
