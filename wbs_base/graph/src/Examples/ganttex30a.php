...
$data = array(
	array(0,"Group 1", "2001-11-01","2001-11-30",FF_FONT1,FS_BOLD,8),
	array(1,"Group 2", "2001-11-01","2001-11-30",FF_FONT1,FS_BOLD,8),
	);

for($i=0; $i<count($data); ++$i) {
	$bar = new GanttBar($data[$i][0],$data[$i][1],$data[$i][2],$data[$i][3],"[20000:40%]",0.32);
	if( count($data[$i])>4 )
