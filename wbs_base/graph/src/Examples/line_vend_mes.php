...
// CALCULO DO SEGUNDO GRAFICO DE FATURAMENTO MENSAL
	...
	$prod->listProdSum("SUM( vpv )","pedido, vendedor", "pedido.codvend = vendedor.codvend AND dataped like '$ano-$u%' and cancel <>  'OK' AND codcliente <> 148 AND codcliente <> 187 and vendedor.nome='$login'", $array, $array_campo , "GROUP  BY pedido.codvend ORDER  BY  `nome`  ASC");
