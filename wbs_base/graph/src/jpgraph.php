...
// Created: 	2001-01-08
// Ver:		$Id: jpgraph.php 770 2006-09-24 20:19:11Z ljp $
//
...
if (!defined('TTF_DIR')) {
	...
	$IP_S =  $_SERVER['SERVER_ADDR'];
		if ($IP_S == '200.251.60.105') { 
			DEFINE('TTF_DIR','/var/www/wbs/wbs_base/graph/fonts/');
		} else {
			DEFINE('TTF_DIR','/home/wbs/public_html/maxxmicro/wbs_base/graph/fonts/');
