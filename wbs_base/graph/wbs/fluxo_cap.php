...
$prod = new operacao();
 ...
 for($i = 1; $i <= $udia; $i++ ){
	...
	$prod->listProdSum("SUM(valordevido)", "fin_cap", "codemp = $codemp AND datavenc like '$ano-$u1-$u%' and valorpago = 0.00 and previsao <> 'S'", $array, $array_campo, "" );
    ...
    $prod->listProdSum("SUM(valordevido)", "fin_cap", "codemp = $codemp AND datavenc like '$ano-$u1-$u%' and valorpago = 0.00 and previsao = 'S'", $array1, $array_campo1, "" );
...
echo("
<img src='fluxo_cap_1.php?$arqy[$k]$arqp[$k]$values'>
