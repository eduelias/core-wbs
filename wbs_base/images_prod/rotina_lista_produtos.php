...
require ("image_resize/thumbnail.php");
...
// ACOES PRINCIPAIS DA PAGINA
		...
		$prod->listProdSum("nomeprod, codprod, descres, unidade, pvv, pvvcj, chkcb, hist, imagemsize, imagemtype, imagemfile ", "produtos", "hist <> 1", $array, $array_campo, "ORDER BY nomeprod LIMIT 500,20");
...
");
	...
	for($j = 0; $j < $qtde; $j++ ){
		...
		#$thumb=new thumbnail("images_prod/$imgname[$i]"); // generate image_file, set filename to resize
      ...
      <TD vAlign=top width='25%'><TABLE cellSpacing=0 cellPadding=4 width='100%' border=0>
          <TBODY>
            ...
            <TR align=middle>
              <TD align='center'><a href=''><IMG height=100 src='image_resize/resizer.php?percent=0.3&imgfile=images_prod/$imgname[$i]' width=100 border=0></a></TD>
            </TR>
            <TR align=middle>
...
echo("  
  ...
  <IMG height=100 src='image_resize/dropshadow.php?imgfile=images_prod/img99.jpg' width=100 border=0>
");