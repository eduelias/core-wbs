...
switch ($Action) {
    ...
    case "update":
	 ...
	 case "reajuste":
		...
		$prod->clear();
		$prod->listProdU("vpv, vt, vc, dataped, fatorvista, taxa, modoentr", "pedido", "codped=$codpedselect");
		$vpv = $prod->showcampo0();
		$vt = $prod->showcampo1();
		$vc = $prod->showcampo2();
...
if ($Actionsec == "list"){
		...
		$prod->listProdSum("codped, pedido.codcliente, codvend, dataped, dataprevent, status, horaprevent, nf, contrato, libentr, codbarra, caixa, nome, pendfpg, reavalfpg, fat, modped, dataprevent_old, aguard_comp", "pedido, clientenovo", $condicao3, $array, $array_campo, $parm );
		}
