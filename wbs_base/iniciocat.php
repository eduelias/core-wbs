...
");
			...
			echo("
			  ...
			  <tr bgcolor='#D6E7EF'>
                            <td width='26%'><b><font size='1' face='Verdana, Arial, Helvetica, sans-serif' color='#000000'>Categotia (MICRO)</font></b></td>
                            <td width='74%' ><font color='#000000' face='Verdana, Arial, Helvetica, sans-serif' size='1'>
");
			if ($Action == "update"){

				if ($xcat_micro == "NO" or $xcat_micro == ""):
				echo("
								 <input type='checkbox' name='cat_micro' value='OK'  > Categoria listavel em um micro.
					");
				else:
				echo("
								 <input type='checkbox' name='cat_micro' value='OK' checked> Categoria listavel em um micro.
					");
				endif;
			}else{
				echo("
							 <input type='checkbox' name='cat_micro' value='' checked>  Categoria listavel em um micro.
				");
			}
			echo("
                              </font></td>
...
/// INICIO - PARTE DE LISTAGEM DOS REGISTROS ////
 ...
 <tr align='center' bgcolor='#93BEE2'>
	 ...
	 <td><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>MICRO</font></b></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
...
if ($cat_micro == "NO" or $cat_micro == ""){$cor6 ="#FF0000";}else{$cor6="#008000";}
	 ...
	 <tr align='center' bgcolor='#D6E7EF'>
		...
		<td><font face='Verdana, Arial, Helvetica, sans-serif' size='1' color = '$cor6'><b>$cat_micro</b></font></td>
