...
if ($Actionsec == "list"){
		...
		$prod->listProdSum("codcliente, nome, tipocliente, cpf, cnpj ", $tabela, $condicao3, $array, $array_campo, $parm );
...
size='1'>$codcliente</font></td>
			<td width='53%' height='0' ><font face='Verdana, Arial, Helvetica, sans-serif'
size='1'>$nome</font></td>
