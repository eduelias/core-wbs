...
$prod = new operacao();
	...
	$prod->listProd("seguranca", "arquivo='inicioclienteform_user.php'");
...
if ($Actionsec == "list"){
		...
		$prod->listProdSum("codcliente, nome, tipocliente, cpf, cnpj, logincad, datadono", $tabela, $condicao3, $array, $array_campo, $parm );
...
echo("
      ...
      <p align='left'><font face='Verdana, Arial, Helvetica, sans-serif' size='1' color='#52A0CF'>$doc: <input type='text' name='$docname' size='20' onchange='consiste$doc(this.form, this.form.$docname.name, true)'></font><br><font face='Verdana' size='1'><input type='checkbox' name='tipo_user' value='1'>MEUS
  CLIENTES</font>
	   </td>
      <td width='26' > 
...
<div align='center'>
  ...
  <tr>
    ...
    <td align='center' width='10%' height='0'> 
      <div align='center'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>TEMPO<br>(dias)</font></b></div>
    </td>
  </tr>
	");
	 ...
	 for($i = 0; $i < count($array); $i++ ){
			...
			$datadono = $prod->showcampo6();

			$datahoje = $prod->gdata();
			$difdias = $prod->numdias($datadono,$datahoje);
		
			if ($difdias > 90 ){$difdias = "EXPIRADO";}
			if (strtolower($xlogincad) != strtolower($login)){$difdias = "";}
...
echo("	
			...
			<td align='center' width='10%' height='0'><font
face='Verdana, Arial, Helvetica, sans-serif' color = '#FF0000'><b>$difdias<!--<a
...
$compl= "retlogin=$retlogin&connectok=$connectok&pg=$pg&tipo_user=$tipo_user";  
