...
<div align='center'>
  ...
  <table border='0' width='550' cellspacing='1'>
    <tr>
      ...
      <td width='110'><font size='1' face='Verdana'><b>PRODUTO COM ESTOQUE</b></font></td>
      <td width='20' bgcolor='#F7BBC4'>&nbsp;</td>
      <td width='123'><font size='1' face='Verdana'><b>PRODUTO SEM <br>
        ESTOQUE</b></font></td>
      <td width='20' bgcolor='#F2E4C4'>&nbsp;</td>
      <td width='235'><font size='1' face='Verdana'><b>PRODUTO FORA<br>
        DE LINHA</b></font></td>
    </tr>
  </table>
  </center>
...
<table width='550' border='0' cellspacing='1' cellpadding='2' align='center'>
    ...
    <td width='10%' height='0'> 
      <div align='center'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>QTDE<br>COMP.</font></b></div>
    </td>
    <td align='center' width='10%' height='0'> 
      <div align='center'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>ESTOQUE</font></b></div>
    </td>
	 <td align='center' width='10%' height='0'> 
	...
	");
	 ...
	 for($i = 0; $i < count($array); $i++ ){
			...
			#if ($estoque < $estoquemin){$cor ="#F7BBC4"; $alarm = "E.C.";}
			#if (($qtdecomp + $estoque) < $estoquemin){$cor ="#F7BBC4";}else{$cor ="#D6E7EF";}
			if ($estoque <= 0){$cor ="#F7BBC4"; $alarm = "E.C.";}
...
echo(" 
	<tr bgcolor='$cor'> 
      ...
      <div align='left'><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>$nomeprod</font></div>
		 ...
		 <td width='10%' height='0'> 
      <div align='center'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>$qtdecomp</font></b></div>
		 </td>
		  <td align='center' width='10%' height='0'> 
      <div align='center'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>$estoque</font></b></div>
		  </td>
