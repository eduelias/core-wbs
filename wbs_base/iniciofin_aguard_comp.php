...
switch ($Action) {
    ...
    case "insert":
			...
			// ATUALIZA BANCO DE DADOS DE PEDIDOS
				...
				$prod->setcampo52($aguard_compselect);  // AGUARDA COMPENSAÇÃO
				
				$prod->upProd("pedido", "codped=$codped");
		
				if ($aguard_compselect == "NO"){$prod->upProdU("pedido","crypt_v = '', crypt_m = '' ", "codped='$codped'");}
...
if ($Actionsec == "list"){
		...
		if ($pedlib =="OK"){
			$condicao4 = " (pedido.status = 'LIB' or pedido.status = 'DESP' or pedido.status = 'ENTR') and pedido.reavalfpg <>'OK' and pedido.cancel <> 'OK' and pedido.aguard_comp = 'OK' and";
		}else{
			$condicao4 = " ((pedido.status <> 'AVAL' and pedido.reavalfpg <>'OK' and pedido.cancel <> 'OK') and pedido.aguard_comp = 'OK' ) and ";
		}
		...
		$prod->listProdSum("codped, pedido.codcliente, pedido.codvend, dataped, dataprevent, status, horaprevent, nf, contrato, libentr, codbarra, caixa, clientenovo.nome, pendfpg, reavalfpg, ckmlb, fat, modped", "pedido, clientenovo, vendedor", $condicao3, $array, $array_campo, $parm );
 ...
 for (cont = 1; cont <= qtde; cont++)
 {
  ...
  for (o = oini; o < (oini+10); o++)
  {
   ...
   strNum = oini + 8;
		...
		if ((form.elements[strTipo].value == '02.01') && ((form.elements[strBanco].value == '') || (form.elements[strAgencia].value == '') || (form.elements[strNum].value == '') || (form.elements[strConta].value == '')))
		{
		...
		if (form.elements[strXAgencia].value != '') 
		{
		...
		if (form.elements[strXConta].value != '')
		{
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td width='51' bgcolor='#FFFFFF'>
                          <p align='center'><font size='1' face='Verdana'><a href='$PHP_SELF?Action=list&amp;codempselect=$codemp&amp;codped=$codped&amp;desloc=$desloc&amp;palavrachave=$palavrachave&amp;operador=$operador&amp;pagina=$pagina&amp;retlogin=$retlogin&amp;connectok=$connectok&amp;pg=$pg&amp;hist=$hist&pgcx=$pgcx&codcxsaldoselect=$codcxsaldoselect&nomevendpesq=$nomevendpesq&pedlib=$pedlib'><img border='0' src='images/bt-continuaped.gif' ><br>
...
<div align='center'>
  ...
  <table border='0' width='550' cellspacing='1' cellpadding='2'>
    ...
    <tr>
      ...
      <td width='50%' bgcolor='#F7CCC1'><font face='Verdana, Arial, Helvetica, sans-serif' size='1'><b><font color='#FF0000'>CLIENTE
...
<div align='center'>
  ...
  <table border='0' width='550'>
    <tr>
      <td width='50%' bgcolor='#FFCC66'><font face='Verdana' size='1'><b>AGUARDAR<br>
        COMPENSAÇÃO:</b></font></td>
      <td width='50%' bgcolor='#FFCC66'><select size='1' class=drpdwn name='aguard_compselect'>
    ...
    <table border='0' width='550' cellspacing='0' cellpadding='2'>
      <tr>
        <td width='100%' align='center'><input class='sbttn' type='submit' value='Atualizar Pedido' name='B1'></td>
      </tr>
    </table>
    </center>
  </div>
...
if ($caixa == "NO"){$cor5 ="#FF0000";}else{$cor5="#008000";}
...
size='1'><b><a
href='$PHP_SELF?Action=update&codped=$codped&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pg&hist=$hist&pgcx=$pgcx&codcxsaldoselect=$codcxsaldoselect&nomevendpesq=$nomevendpesq&pedlib=$pedlib'>$codbarra</b></a><br>$descfat</font></td>
...
echo("
			...
			<td align='center' width='2%' height='0'><font face='Verdana, Arial, Helvetica, sans-serif' size='1' color='$cor5'><b>$caixa</b></font></td>
