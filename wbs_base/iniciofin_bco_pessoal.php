...
if($Action == "update"):
		...
		// LISTA OS REGISTROS DE ACORDO COM O ACRESCIMO DEFINIDO
		$prod->listProdSum("codmov, codconta, codcxlanc, codcxopera, opcaixa, descricao, datamov, dataini, credito, debito, consolida, codped, obs, codos", "fin_bcomov", $condicao3, $array, $array_campo, "order by datamov " );
      ...
      <td width='100%'>
        <table border='0' width='100%' cellspacing='0' cellpadding='0'>
         <tr>
            ...
            <td width='20%'><font face='Verdana, Arial, Helvetica, sans-serif' color='#0066CC' size='1'><b> <a href='$PHP_SELF?Action=insmov&codcontaselect=$codcontaselect&codcxsaldoselect=$codcxsaldoselect&codempselect=$codempselect&&retlogin=$retlogin&connectok=$connectok&pg=$pg&desloc=$desloc'>INSERIR
              MOVIMENTAÇÃO</a></b></font></td>
            <td width='5%'>
              <p align='center'><img border='0' src='images/refresh.gif'></td>
            <td width='20%'><b><a href='$PHP_SELF?Action=update&codcontaselect=$codcontaselect&codcxsaldoselect=$codcxsaldoselect&codempselect=$codempselect&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pg&hist=0'><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>ATUALIZAR
        TABELA</font></a></b></td>
          </center>
				 <td width='5%'><img border='0' src='images/print.gif'></td>
            <td width='20%'><font face='Verdana, Arial, Helvetica, sans-serif' color='#0066CC' size='1'> <a href='javascript:void(0)' onclick=");echo('"');echo("NewWindow('restrito.php?Action=update&desloc=$desloc&codempselect=$codempselect&codcxsaldoselect=$codcxsaldoselect&codcxselect=$codcxselect&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pgextr&pgcx=$pg&codcontaselect=$codcontaselect','EXTRATO','600','400','yes');return 
...
<center>
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=550>
	  ...
	  ");
	$prod->listProdSum("opcaixa, descricao", "formapg", "opcaixa like '01.50' or opcaixa like '01.51'", $array1, $array_campo1, "" );
