...
switch ($Action) {
    ...
    case "insert":
		   ...
		   echo("$codprojnew - $codempnew - $codvendnew");
...
if($Action == "update"):
		...
		// PARA PAGINA DE TRANFERENCIA DE CAIXA
		$prod->listProd("seguranca", "arquivo='iniciofin_caixa_transf_admin.php'");
		$pgtransf = $prod->showcampo0();

		// PARA PAGINA DE TRANFERENCIA DE CAIXA
		$prod->listProd("seguranca", "arquivo='iniciofin_aguard_comp.php'");
		$pgagcomp = $prod->showcampo0();

		// PARA PAGINA DE TRANFERENCIA DE CAIXA
		$prod->listProd("seguranca", "arquivo='iniciofin_caixa_impressao.php'");
    ...
    <tr>
      <td width='100%'>
        <table border='0' width='100%' cellspacing='0' cellpadding='0'>
          <tr>
            <td width='14%' align='center'><img border='0' src='images/empresa.gif' width='25' height='26'><font face='Verdana, Arial, Helvetica, sans-serif' color='#000000' size='1'><b><br><a href='javascript:void(0)' onclick=");echo('"');echo("NewWindow('restrito.php?Action=list&desloc=$desloc&codempselect=$codempselect&codcxsaldoselect=$codcxsaldoselect&codcxselect=$codcxselect&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pgrecped&pgcx=$pg','RECPED','600','400','yes');return 
false");echo('"');echo("> RECEBER<br>
            PEDIDO</a>
           </b></font></td>
            <td width='14%' align='center'><img border='0' src='images/empresa.gif' width='25' height='26'><font face='Verdana, Arial, Helvetica, sans-serif' color='#000000' size='1'><b><br><a href='javascript:void(0)' onclick=");echo('"');echo("NewWindow('restrito.php?Action=list&desloc=$desloc&codempselect=$codempselect&codcxsaldoselect=$codcxsaldoselect&codcxselect=$codcxselect&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pgcap&pgcx=$pg','CAP','600','400','yes');return 
false");echo('"');echo("> PGTO<br>
            CONTAS</a>
            </b></font></td>
            <td width='14%' align='center'><img border='0' src='images/empresa.gif' width='25' height='26'><font face='Verdana, Arial, Helvetica, sans-serif' color='#000000' size='1'><b><br><a href='javascript:void(0)' onclick=");echo('"');echo("NewWindow('restrito.php?Action=list&desloc=$desloc&codempselect=$codempselect&codcxsaldoselect=$codcxsaldoselect&codcxselect=$codcxselect&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pgcar&pgcx=$pg','CAR','600','400','yes');return 
false");echo('"');echo("> RECEBER<br>
            CONTAS</a>
           </b></font></td>
            <td width='15%' align='center'><img border='0' src='images/empresa.gif' width='25' height='26'><font face='Verdana, Arial, Helvetica, sans-serif' color='#000000' size='1'><b><br><a href='javascript:void(0)' onclick=");echo('"');echo("NewWindow('restrito.php?Action=list&desloc=$desloc&codempselect=$codempselect&codcxsaldoselect=$codcxsaldoselect&codcxselect=$codcxselect&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pgbco&pgcx=$pg','BANCO','600','400','yes');return 
false");echo('"');echo("> OPERAÇÕES<br>
          ...
          <td width='14%' align='center'>
            ...
            <font face='Verdana, Arial, Helvetica, sans-serif' size='1'><a href='javascript:void(0)' onclick=");echo('"');echo("NewWindow('restrito.php?Action=list&desloc=$desloc&codempselect=$codempselect&codcxsaldoselect=$codcxsaldoselect&codcxselect=$codcxselect&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pgcofre&pgcx=$pg','COFRE','600','400','yes');return 
false");echo('"');echo("> SAÍDA<br>
            COFRE</a></font></b></td>
			<td width='15%' align='center'><img border='0' src='images/empresa.gif' width='25' height='26'><font face='Verdana, Arial, Helvetica, sans-serif' color='#000000' size='1'><b><br><a href='javascript:void(0)' onclick=");echo('"');echo("NewWindow('restrito.php?Action=list&desloc=$desloc&codempselect=$codempselect&codcxsaldoselect=$codcxsaldoselect&codcxselect=$codcxselect&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pgtransf&pgcx=$pg','TRANSFERÊNCIA','600','400','yes');return 
false");echo('"');echo("> TRANSF.<br>
            CAIXA</a>
            </b></font></td>
          <td width='15%' align='center'>
            ...
            CAIXA</b></font>
			 ...
			 <tr>
            <td width='14%' align='center'><img border='0' src='images/empresa.gif' width='25' height='26'><font face='Verdana, Arial, Helvetica, sans-serif' color='#000000' size='1'><b><br><a href='javascript:void(0)' onclick=");echo('"');echo("NewWindow('restrito.php?Action=list&desloc=$desloc&codempselect=$codempselect&codcxsaldoselect=$codcxsaldoselect&codcxselect=$codcxselect&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pgagcomp&pgcx=$pg','AGCOMP','600','400','yes');return 
false");echo('"');echo("> AGUARDA<br>
            COMPENSAÇÃO</a>
           </b></font></td>
      ...
      <td width='100%'>
        <table border='0' width='100%' cellspacing='0' cellpadding='0'>
          <tr>
            ...
            <td width='25%'><b><a href='$PHP_SELF?Action=update&codcxselect=$codcxselect&codcxsaldoselect=$codcxsaldoselect&codempselect=$codempselect&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pg&hist=0'><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>ATUALIZAR
        TABELA</font></a></b></td>
			 <td width='5%'><img border='0' src='images/print.gif'></td>
            <td width='25%'><font face='Verdana, Arial, Helvetica, sans-serif' color='#0066CC' size='1'> <a href='javascript:void(0)' onclick=");echo('"');echo("NewWindow('restrito.php?Action=update&desloc=$desloc&codempselect=$codempselect&codcxsaldoselect=$codcxsaldoselect&codcxselect=$codcxselect&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pgextr&pgcx=$pg','EXTRATO','600','400','yes');return 
false");echo('"');echo("> EXTRATO<br>
           CAIXA</a>
...
/// CONTADOR DE PAGINAS ////
$compl= "codempselect=$codempselect&codcxselect=$codcxselect&codcxsaldoselect=$codcxsaldoselect&retlogin=$retlogin&connectok=$connectok&pg=$pg&hist=$hist&opcaixa=$opcaixa";   
...
<table width='550' border='0' cellspacing='0' cellpadding='0' align='center' >
  <tr><form>
		<td width='5%'><img border='0' src='images/novodado.gif' width='25' height='26'></td>
        <td width='25%'><font face='Verdana, Arial, Helvetica, sans-serif' color='#000000' size='1'><b> <a href='$PHP_SELF?Action=insert&retlogin=$retlogin&connectok=$connectok&pg=$pg&insertini=1&desloc=$desloc'>INSERIR
              NOVO CAIXA</a></b></font></td>
