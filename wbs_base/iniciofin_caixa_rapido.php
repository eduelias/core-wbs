...
if($Action == "update"):
		...
		$prod->listProd("seguranca", "arquivo='iniciofin_recped_rapido.php'");
		$pgrecped = $prod->showcampo0();

		// PARA PAGINA DO CONTAS A RECEBER
		$prod->listProd("seguranca", "arquivo='iniciofin_pedido_rapido.php'");
		$pgpedr = $prod->showcampo0();
	...
	");
	 ...
	 for($l = 1; $l < count($xcaixashow); $l++ ){
			...
			if ($xcaixashow[$l] <> ""){
				...
				if ($codemp_transf <> 0){$condcx .= " and codemp = $codemp_transf ";}
