...
switch ($Action) {
	...
	case "inscentrocusto":
			...
			$prod->listProdU("opcaixa, valordevido, datavenc, codemp","fin_cap", "codcap='$codcapselect'");
			...
			$prod->listProdSum("valor", "projeto_relacao_custo","codcap='$codcapselect'", $array45, $array_campo45, "" );
				$soma_pt = 0;
...
if ($Actionsec == "list"){
		...
		if ($codempselect <> ""):
			...
			$condicao3 .= "opcaixa not like '800.%' and opcaixa not like '810.%' and ";
			if ($hist == "S"){
				$condicao3 .= "hist = 'S'";
			}else{
				$condicao3 .= "hist = 'N'";
...
<div align='center'>
  <center>
  <table border='0' cellpadding='1' cellspacing='0' style='border-collapse: collapse' bordercolor='#111111' 
 <tr>
