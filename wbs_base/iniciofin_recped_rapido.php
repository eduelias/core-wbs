...
function EnviaNF()
{
		...
		for (var j=0; j < 5; j++)
		{
			...
			if (days < -1 ){alert('A DATA do DOCUMENTO '+j+' não pode ser inferior a DATA DO PEDIDO');return false; }
			if (days > 90 ){alert('A DATA do DOCUMENTO '+j+' não pode ser superior a 90 DIAS');return false; }
...
echo("
	...
	<tr bgcolor='$bgcorlinha'>
		...
		<td width='20%' ><font size='1' face='Verdana'><b>R$ $valorparcelaf</b></font></td>
...
echo("
	...
	<tr bgcolor='$bgcorlinha'>
		...
		<input type='hidden' name='auth_cheq[$ji]' size='20' value = 'N' >
");
	$errofat = $errofat*0;
	}else{
echo("
...
echo ("
	...
	<form method='POST' action='$PHP_SELF?Action=fat&codcxsaldoselect=$codcxsaldoselect'  name='Form' >
  <div align='center'>
    <center>
    <table cellSpacing='1' cellPadding='3' width='550' border='0'>
      <tr bgColor='#f3f8fa'>
