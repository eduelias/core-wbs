		 ...
		 for($k = 0; $k < count($array98); $k++ ){
			...
			$prod->listProdSum("codvend", "relacaohierarquia", "codsuper = $codvend_sub", $array99, $array_campo99, "" );
			 for($t = 0; $t < count($array99); $t++ ){
				...
				$condicao4 .= " orc.codvend=$codvendselect ) and ";
		}else{
      ...
      <hr size='1'>
        ...
        <table border='0' width='100%' cellspacing='0' cellpadding='0'>
          <tr>
            ...
            <td width='61%'><font face='Verdana, Arial, Helvetica, sans-serif' color='#000000' size='1'><b>ORÇAMENTO:</b></font><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1' color='#FFFFFF'>
");
if ($codgrpselect <> 48){
echo("
