			...
			// INSERE PARCELAS NOS REPECTIVOS CAMPOS DA FORMAPG
				...
				if ($caixa) {
					...
					if ($cxaberto == 0 ){
						...
						$erro[$i] = 0;
						$msg[$i] = "Nenhum CAIXA est� aberto. Abra um novo CAIXA para poder efetuar a opera��o";
				...
				if ($car) {
					...
					if ($pnumdoc == "S" and $numdoc[$codparcped] == "" and $opcaixa == "02.60"){
						...
						$erro[$i] = 0;
						$msg[$i] = "O NUM. DOCUMENTO (DTI) da Parcela $i n�o foi preenchido";
  ...
  //////////////////////////ACERTA VALORES NO CENTRO DE CUSTO          		
    ...
    case "update":
	 ...
	 case "cancel_sol":
		...
		$prod->setcampo1($codped);
		$prod->setcampo2($dataatual);
		$prod->setcampo3("CANCEL SOLICITA��O FAT");
		$prod->setcampo4($login);
...
function EnviaNF()
{
		...
		for (var j=0; j < 5; j++)
		{
			...
			if ((document.getElementById(_objdnf).value == '' || document.getElementById(_objmnf).value == '' || document.getElementById(_objanf).value == '')){alert('A DATA do DOCUMENTO '+u+' deve ser preenchido corretamente.');return false; }
				...
				var now = new Date();
				var dataped = new Date(document.getElementById('aped').value, document.getElementById('mped').value-1, document.getElementById('dped').value);
				var diff = date2.getTime() - dataped.getTime()
...
document.getElementById('nf_imp').src+='&ie=true';
...
if($Action == "insert" or $Action == "update" or $Action == "delete"):
	...
	$prod->listProdU("nome, codemp", "vendedor", "codvend='$codvend'");
		...
		if ($codemp == $codemp_pis or $codemp_pis == 0){
			...
			if ($codgrupo_emppis == $codgrupo_pedido){$tipo_nota = "TRANFER�NCIA";}else{$tipo_nota = "VENDA";}
...
<div align='center'>
  <table border='0' width='90%' cellspacing='1' cellpadding='0'>
    <tr>
      ...
      <td width='50%' bgcolor='#000000'>
      <p align='right'><font face='Verdana, Arial, Helvetica, sans-serif' color='#86ACB5' size='1'><b>USU�RIO</b></font><font size='1'><b><font color='#86ACB5' face='Verdana, Arial, Helvetica, sans-serif'>:</font><font color='#336699' face='Verdana, Arial, Helvetica, sans-serif'><br>
...
echo("
    ...
    <tr>
      <td width='50%' bgcolor='#F0F0F0'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'><font color='#336699'>NOME/ RAZ�O SOCIAL:<br>
...
<div align='center'>
  ...
  <table border='0' width='90%' cellspacing='1' cellpadding='2'>
    ...
    <tr>
      ...
      <td width='50%' bgcolor='#F0F0F0'><font size='1'><b><font face='Verdana, Arial, Helvetica, sans-serif' color='#336699'>OCUPA��O:<br>
        </font></b><font color='#000000' face='Verdana, Arial, Helvetica, sans-serif'>$xc_ocupacao</font></font></td>
    </tr>
    <tr>
      <td width='50%' bgcolor='#F0F0F0'><font size='1'><b><font face='Verdana, Arial, Helvetica, sans-serif' color='#336699'>DESCRI��O:<br>
    ...
    <tr>
      <td width='100%' bgcolor='#F0F0F0' colspan='2'><font size='1'><b><font color='#336699' face='Verdana, Arial, Helvetica, sans-serif'>ENDERE�O
        COMERCIAL:<br>
        </font>
    ...
    <tr>
      <td width='50%' bgcolor='#F0F0F0'><font size='1'><b><font face='Verdana, Arial, Helvetica, sans-serif' color='#336699'>ENDERE�O
        CORRESP:<br>
...
<div align='center'>
  ...
  <table border='0' width='90%' cellspacing='1' cellpadding='2'>
    ...
    <tr>
      <td width='50%' bgcolor='#F0F0F0'><font face='Verdana, Arial, Helvetica, sans-serif' color='#336699' size='1'><b>INSCRI��O
...
<div align='center'>
  ...
  <table border='0' width='90%' cellspacing='1' cellpadding='2'>
    <tr>
      <td width='100%' bgcolor='#C0C0C0'><font size='1' face='Verdana' color='#FFFFFF'><b>S�CIO
        SOLID�RIO</b></font></td>
    </tr>
");
...
<form method='POST' action='$PHP_SELF?Action=cancel_sol'  name='Form77' >
  <div align='center'>
    ...
    <table cellSpacing='1' cellPadding='3' width='90%' border='0'>
      <tr bgColor='#f3f8fa'>
        <td>  <input type='submit' value='CANCELAR SOLICITA��O DE NOTA' name='B1'></td>
      </tr>
    </table>
...
echo ("
	   <table width='90%' border='0' align='center' cellpadding='5' cellspacing='1'>
		  <tr bgcolor='#336633'>
			<td><font face='Verdana' size='1' color = '#FFFFFF'><b>IMPRESS�O DOCUMENTO FISCAL:</b></font></td>
		  </tr>
		<tr>
		<td>
    ...
    <tr>
      <td>
        ...
        <div class='warning'>
          <p><b>Verifique a inscri��o estadual do cliente! </b></p>
		  <p>IE: $ie_nf </p>
		  <p><b>O cliente Pessoal Jur�dica � ISENTO de Incri��o Estadual ?</b></p>
          <table width='100%' border='0'>
            <tr>
              <td width='50%'><a href='javascript:hideDiv()'>SIM</a></td>
              <td width='50%'><a href='javascript:showDiv()'>N�O</a></td>
            </tr>
          </table>
          </div>
...
");		
	...
	$prod->clear();
	$prod->listProdU("DAYOFMONTH( dataped ) , MONTH( dataped ) , YEAR( dataped )", "pedido", "codped=$codped");
	$dped = $prod->showcampo0();
	$mped = $prod->showcampo1();
	$aped = $prod->showcampo2();
	
echo("


	<input type='hidden' name='dped' id ='dped'  value = '$dped'>
	<input type='hidden' name='mped' id ='mped'  value = '$mped'>
	<input type='hidden' name='aped' id ='aped'  value = '$aped'>
