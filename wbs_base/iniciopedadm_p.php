...
if ($Actionsec == "list"){
		...
		$prod->listProdSum("codped, pedido.codcliente, pedido.codvend, dataped, dataprevent, status, horaprevent, nf, contrato, libentr, codbarra, caixa, clientenovo.nome, vendedor.nome as nomevend, modped, dataprevent_old", "pedido, clientenovo, vendedor", $condicao3, $array, $array_campo, $parm );
...
function verificaObrig (form) 
{
 ...
 if (document.getElementById('inst_ok').checked == false)
	{
		alert ('Marque o campo de instalação do software');
...
if ($cbped == "OK"){
echo("
<form method='POST' action='$PHP_SELF?Action=insert'  name='Form' onSubmit = 'if (verificaObrig(Form)==false) return false'>
  <div align='center'>
    <center>
    <table cellSpacing='1' cellPadding='3' width='550' border='0'>
      <tr bgColor='#f3f8fa'>
...
if ($declara == "OK"){
echo("
 			<input name='inst_ok' type='checkbox' value='OK' id ='inst_ok'>
			<font face='Verdana' size='1'><b>A INSTALAÇÃO DO SOFTWARE FOI FEITA CORRETAMENTE.</b></font>
  ");
}
echo("	
            </td>
