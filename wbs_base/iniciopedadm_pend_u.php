...
if ($Actionsec == "list"){
		...
		$campopesq = "nome";
		$condicao2 = " LCASE(clientenovo.$campopesq) like '%$palavrachave1%' ";
		$condicao5 = " LCASE(vendedor.$campopesq) like '%$nomevendselect1%' ";
		$condicao4 = " ((pedido.hist <> 1) and (pedido.status <> 'AVAL') and ((pedido.contrato = 'NO' or  pedido.contrato = 'EP') or (pedido.fichaentr = 'NO') or (pedido.caixa = 'NO')))";
		...
		if ($palavrachave == ""):
		 ...
		 if ($nomevendselect == ""):
			...
			$condicao2 = "";
				...
				if ($codpedpesq <>""):
					...
					$condicao3 = " pedido.codvend='$codvendselect' and pedido.codcliente=clientenovo.codcliente and pedido.codvend=vendedor.codvend and " . $condicao4;
				endif;
			
			
		 else:

			$condicao3 = " pedido.codcliente=clientenovo.codcliente and pedido.codvend=vendedor.codvend and " . $condicao4 . " and " . $condicao5;
		 ...
		 if ($nomevendselect == ""):
				...
				if ($codpedpesq <>""):
					...
					$condicao3 = " pedido.codvend='$codvendselect' and pedido.codcliente=clientenovo.codcliente and pedido.codvend=vendedor.codvend and " . $condicao4 . " and " . $condicao2;
				endif;
...
<div align='center'>
  ...
  <table border='0' width='550' cellspacing='1' cellpadding='2'>
    ...
    <tr>
      ...
      <td width='25%'>
        <p align='center'><font size='1' face='Verdana'><b>:: LIB. ENTREGA: <font color='$cor2'>$fichaentr</font></b></font></td>
      <td width='25%'>
...
<div align='center'>
  ...
  <table cellSpacing='1' cellPadding='3' width='550' border='0'>
      ...
      <tr bgColor='#86acb5'>
        <td width='40%'><font face='Verdana' color='#ffffff' size='1'><b>DATA
          STATUS</b></font></td>
        <td width='60%'><font face='Verdana' color='#ffffff' size='1'><b>STATUS</b></font></td>
...
echo("
      <tr bgColor='#f3f8fa'>
        <td width='40%'><font face='Verdana' size='1'>$datastatusf</font></td>
        <td width='60%'><font face='Verdana' size='1'><b>$statusped</b></font></td>
      </tr>
");		
	}
echo("
...
/// CONTADOR DE PAGINAS ////
$compl= "codempselect=$codempselect&nomevendselect=$nomevendselect&codvendselect=$codvendselect&retlogin=$retlogin&connectok=$connectok&pg=$pg&hist=$hist";   
