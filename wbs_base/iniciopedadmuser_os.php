...
if ($Actionsec == "list"){
		...
		$condicao4 = " (pedido.status = 'DESP' or pedido.status = 'ENTR') and pedido.modped <> 'OK' and pedido.fat = 'OK' and pedido.caixa = 'OK' and pedido.libentr = 'OK' and (pedido.contrato = 'OK' or  pedido.contrato = 'EP' or  pedido.contrato = 'DC' ) and";
		...
		if ($codpedpesq){
			...
			$condicao3 .= " pedido.codbarra='$codpedpesq' and";
				...
				$condicao3 .= " pedido.codcliente=clientenovo.codcliente ";
