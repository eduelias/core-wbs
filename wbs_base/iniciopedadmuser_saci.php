...
if ($Actionsec == "list"){
		...
		if ($codgrpselect == 2 or $codgrpselect == 29 or $codgrpselect == 54 ){
			$condicao4 = "";
		}
		...
		// LISTA OS REGISTROS DE ACORDO COM O ACRESCIMO DEFINIDO
		$prod->listProdSum("codped, pedido.codcliente, pedido.codvend, dataped, dataprevent, status, horaprevent, nf, contrato, libentr, codbarra, caixa, clientenovo.nome, pendfpg, reavalfpg, fat, vendedor.nome, modped, dataprevent_old, aguard_comp", "pedido, clientenovo, vendedor", $condicao3, $array, $array_campo, $parm );
 ...
 <div align='center'>
    ...
    <table cellSpacing='1' cellPadding='3' width='550' border='0'>
      <tr bgColor='#f3f8fa'>
        ...
        <td width='554'>
			<input type='text' name='ncontato' size='48' maxlength='250'>	<input type='submit' value='OK' name='B1'>
        </td>
      </tr>
    </table>
    </center>
  ...
  <div align='center'>
    ...
    <table cellSpacing='1' cellPadding='3' width='50%' border='0'>
      <tr >
        ...
        <td align='left' width='90%' height='0'>
...
false");echo('"');echo(">IMPRIMIR PEDIDO</a></b></font>
 </tr>
  </table>
      ...
      <hr size='1'>
        ...
        <table border='0' width='100%' cellspacing='0' cellpadding='0'>
          <tr>
            ...
            <td width='30%'><font face='Verdana, Arial, Helvetica, sans-serif' color='#000000' size='1'><b>PEDIDO:</b></font><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1' color='#FFFFFF'><a href='$PHP_SELF?Action=list&codprod=$codprod&codempselect=$codempselect&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&codprodpesq=$codprodpesq&retlogin=$retlogin&connectok=$connectok&pg=$pg&hist=0&nomevendpesq=$nomevendpesq'><br>
              EM ABERTO</a></font></b></td>
            <td width='7%'>
              <p align='center'><img border='0' src='images/historico.gif' width='20' height='22'></td>
            <td width='61%'><font face='Verdana, Arial, Helvetica, sans-serif' color='#000000' size='1'><b>PEDIDO:</b></font><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1' color='#FFFFFF'><a href='$PHP_SELF?Action=list&codprod=$codprod&codempselect=$codempselect&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&codprodpesq=$codprodpesq&retlogin=$retlogin&connectok=$connectok&pg=$pg&hist=1&nomevendpesq=$nomevendpesq'><br>
...
size='1'><b><a
href='$PHP_SELF?Action=update&codped=$codped&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pg&hist=$hist&nomevendpesq=$nomevendpesq'>$codbarra</font></b></a><br><font face='Verdana, Arial, Helvetica, sans-serif'
...
echo("
			<td align='center' width='2%' height='0'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1' color = '$cor1'>
			<a href='javascript:void(0)' onclick=");echo('"');echo("NewWindow('$arqcontrato?Action=update&desloc=$desloc&codped=$codped&codemp=$codemp&desloc=$desloc&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pg&impressao=1','name','650','400','yes');return false");echo('"');echo(">CR</a></font></b></td>
			<td align='center' width='2%' height='0'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1' color = '$cor1'>
