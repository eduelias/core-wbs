...
<div align='center'>
  ...
  <table width='100%'>
	...
	VERIFICAR DISPONIBILIDADE ENCOMENDA<br>
 	INDISPONÍVEL<br>-->
      <img src='images/logo_maxxmicro.jpg'  /></td>
    </center>
...
echo("
  ...
  <tr>
    ...
    <td width='60%' height='0'> 
      <div align='center'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>PRODUTO</font></b></div>
    </td>
  
    <td align='center' width='10%' height='0'> 
      <div align='center'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>PREÇO<BR>à vista<BR>(R$)</font></b></div>
    </td>
	 <td align='center' width='10%' height='0'> 
      <div align='center'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>PREÇO<BR>14 dias<BR>(R$)</font></b></div>
    </td>
	 <td align='center' width='10%' height='0'> 
      <div align='center'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>PREÇO<BR>28 dias<BR>(R$)</font></b></div>
    </td>
...
$xcodsubcat = $codsubcat;
	...
	if ($kit_no <> 1  and $pvd > 0 and $estoque > 0){
		...
		<tr bgcolor='$cor'> 
			...
			<td width='60%' height='0'><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>$nomeprod</font><br><font face='Verdana, Arial, Helvetica, sans-serif' size='1' color='#808080'>$descres</font></td>
			
			<td align='center' width='10%' height='0'><font face='Verdana, Arial, Helvetica, sans-serif' size='1'><b>$pvdf</b>"); if ($pvdcj <> $pvd and $libfatdir <> 'OK'){ echo("<br>FAT DIR: $pvdcjf");}echo("</font></td>
