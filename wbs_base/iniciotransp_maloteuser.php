...
if ($Actionsec == "list"){
		...
		if ($codpesq){
			...
			$condicao3 .= " transp_malote.codmal='$codpesq' and";
				...
				$condicao3 .= " and transp_malote.hist = '$hist'  ";
      ...
      <td width='100%'>
        <table border='0' width='100%' cellspacing='0' cellpadding='0'>
          <tr>
            ...
            <td width='25%'><font face='Verdana, Arial, Helvetica, sans-serif' color='#0066CC' size='1'><b> <a href='$PHP_SELF?Action=insert&desloc=$desloc&retlogin=$retlogin&connectok=$connectok&pg=$pg&nomevendpesq=$nomevendpesq'>SOLICITAR
              NOVO MALOTE</a></b></font></td>
            <td width='5%'>
