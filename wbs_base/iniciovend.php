...
switch ($Action) {
	...
	if (count($array614) == 0){
		...
		$prod->setcampo45($tipo_celular);
		$prod->setcampo47($mcv_prot_max);
		$prod->setcampo48($mcv_prot_min);
		$prod->setcampo49($mcv_incre);
		if ( $meia_mcv_hab == ""){$meia_mcv_hab = "N";}
		$prod->setcampo50($meia_mcv_hab);
		$prod->setcampo51($tipo_info);
		$prod->setcampo52($tipo_tecnico);
		$prod->setcampo54($fatorusertabela_cel);
		$prod->setcampo55($fatorusertabela_ata);
		$prod->setcampo56($fatormajor);
		$prod->setcampo57($codvend_dist);
		$prod->setcampo58($lucro_min);
		$prod->setcampo59($fatorcomfixo);
		$prod->setcampo60($fatorcomvar);
		$prod->setcampo61($ped_bol);
		...
		if ($meta_ano <> "" and $meta_ano <>  ""){
		//CRIA META CELULAR VENDEDOR
		$prod->clear();
		$prod->setcampo1($ureg);
		$prod->setcampo2("$meta_ano-$meta_mes-01");
		$prod->setcampo3($meta_pi);
		$prod->setcampo4($meta_pc);
		$prod->setcampo5($meta_pcar);
		$prod->setcampo6($meta_pcar_fat);
		
		$prod->addProd("vendedor_meta", $uregmeta);
		}
		
		if ($login_user_sub <> "" and $senha_user_sub <>  ""){
		//CRIA SUB VENDEDOR
		$prod->clear();
		$prod->setcampo4($ureg);
		$prod->setcampo1($login_user_sub);
		$prod->setcampo2(MD5($senha_user_sub));
		$prod->setcampo3($tipo_user_sub);
	
		$prod->setcampo5('N');

		
		$prod->addProd("vendedor_usuario", $uregmeta);
		}
    ...
    case "update":
		...
		$xtipo_celular = $prod->showcampo45();
		$xmcv_prot_max = $prod->showcampo47();
		$xmcv_prot_min = $prod->showcampo48();
		$xmcv_incre = $prod->showcampo49();
		$xmeia_mcv_hab = $prod->showcampo50();
		if ($xmeia_mcv_hab == "S"){$chk_meiamcv_hab = "checked";}else{$chk_meiamcv_hab = "";}
		#echo("tco=$tipoclienteold");
		$xtipo_info = $prod->showcampo51();
		$xtipo_tecnico = $prod->showcampo52();
		$xfatorusertabela_cel = $prod->showcampo54();
		$xfatorusertabela_ata = $prod->showcampo55();
		$xfatormajor = $prod->showcampo56();
		$xcodvend_dist = $prod->showcampo57();
		$xlucro_min = $prod->showcampo58();
		$xfatorcomfixo = $prod->showcampo59();
		$xfatorcomvar = $prod->showcampo60();
		$xped_bol = $prod->showcampo61();
		if ($retorno){
	 ...
	 case "delete":
		...
		$prod->delProd("vendedor_meta" , "codmvend = $codmvend_select");
		...
		$prod->delProd("vendedor_usuario" , "codvend_user = $codmvend_select");
  ...
  LISTAR TODAS AS EMPRESAS</font></b><BR><b>
	...
	$prod->listProdSum("codcx, codemp, nomecx" , "fin_cx", "1", $array45, $array_campo45, "order by codemp" );
	 ...
	 for($i = 0; $i < count($array45); $i++ ){
			...
			$prod->listProdU("nome, hist_emp", "empresa", "codemp=$codemp_cx");
			$nomeemp_cx = $prod->showcampo0();
			$histemp_cx = $prod->showcampo1();
			
			$prod->listProdU("block", "vendedor", "nome='$nomecx'");
			$histnome_cx = $prod->showcampo0();
	...
	if ($histemp_cx <> 'S' and $histnome_cx <> 'Y'){
echo("
...
$chk = "";
	...
	echo("
						 ...
						 <tr bgcolor='#D6E7EF'> 
						  ...
						  <tr bgcolor='#D6E7EF'> 
                            <td width='26%' ><b><font size='1' face='Verdana, Arial, Helvetica, sans-serif' color='#000000'>Fator Usuário Tabela (Celular):</font></b></td>
                            <td width='74%' colspan ='2' ><font color='#000000' face='Verdana, Arial, Helvetica, sans-serif' size='2'> 
				
                                <input type='text' value='$xfatorusertabela_cel' name='fatorusertabela_cel' size='8' >
			                          
                              </font></td>
                          </tr>
						  <tr bgcolor='#D6E7EF'> 
                            <td width='26%' ><b><font size='1' face='Verdana, Arial, Helvetica, sans-serif' color='#000000'>Fator Usuário Tabela (Atacado):</font></b></td>
                            <td width='74%' colspan ='2' ><font color='#000000' face='Verdana, Arial, Helvetica, sans-serif' size='2'> 
				
                                <input type='text' value='$xfatorusertabela_ata' name='fatorusertabela_ata' size='8' >
			                          
                              </font></td>
                          </tr>
						   <tr bgcolor='#D6E7EF'> 
                            <td width='26%' ><b><font size='1' face='Verdana, Arial, Helvetica, sans-serif' color='#000000'>Fator Majoração (Rev Dist):</font></b></td>
                            <td width='74%' colspan ='2' ><font color='#000000' face='Verdana, Arial, Helvetica, sans-serif' size='2'> 
				
                                <input type='text' value='$xfatormajor' name='fatormajor' size='8' >
			                          
                              </font></td>
                          </tr>
						    <tr bgcolor='#D6E7EF'> 
                            <td width='26%' ><b><font size='1' face='Verdana, Arial, Helvetica, sans-serif' color='#000000'>Fator Lucro Min (Rev Dist):</font></b></td>
                            <td width='74%' colspan ='2' ><font color='#000000' face='Verdana, Arial, Helvetica, sans-serif' size='2'> 
				
                                <input type='text' value='$xlucro_min' name='lucro_min' size='8' >
			                          
                              </font></td>
                          </tr>
						   <tr bgcolor='#D6E7EF'> 
                            <td width='26%' ><b><font size='1' face='Verdana, Arial, Helvetica, sans-serif' color='#000000'>CodVendedor (Distribuição):</font></b></td>
                            <td width='74%' colspan ='2' ><font color='#000000' face='Verdana, Arial, Helvetica, sans-serif' size='2'> 
				
                                <input type='text' value='$xcodvend_dist' name='codvend_dist' size='4' >
                            ...
                            <td width='74%' colspan ='2'><font color='#000000' face='Verdana, Arial, Helvetica, sans-serif' size='2'> 
                                ...
                                <input type='text' value='$xfatorcomissao_serv' name='fatorcomissao_serv' size='8' >
						  	  	  ...
						  	  	  <tr bgcolor='#D6E7EF'> 
                            <td width='26%' ><b><font size='1' face='Verdana, Arial, Helvetica, sans-serif' color='#000000'>Fator Comissão Fixo:</font></b></td>
                            <td width='74%' colspan ='2'><font color='#000000' face='Verdana, Arial, Helvetica, sans-serif' size='2'> 
				
                                <input type='text' value='$xfatorcomfixo' name='fatorcomfixo' size='8' > <font face='Verdana, Arial, Helvetica, sans-serif' size='1' color='#000000'> DISTRIBUIÇÃO </font>
			                          
                              </font></td>
                          </tr>
						    	  <tr bgcolor='#D6E7EF'> 
                            <td width='26%' ><b><font size='1' face='Verdana, Arial, Helvetica, sans-serif' color='#000000'>Fator Comissão Var:</font></b></td>
                            <td width='74%' colspan ='2'><font color='#000000' face='Verdana, Arial, Helvetica, sans-serif' size='2'> 
				
                                <input type='text' value='$xfatorcomvar' name='fatorcomvar' size='8' > <font face='Verdana, Arial, Helvetica, sans-serif' size='1' color='#000000'> DISTRIBUIÇÃO </font>
	...
	echo("	
			...
			echo("
				...
				");
                                if ($xtipo_celular=="Y"):
			echo("
                             <input type='checkbox' name='tipo_celular' value='Y' checked ><b>VENDEDOR DE CELULAR</b> (grafico de celular)
				");
			else:
			echo("
                             <input type='checkbox' name='tipo_celular' value='Y' > <b>VENDEDOR DE CELULAR</b> (grafico de celular)
				");
			endif;
			echo("
			 ...
			 <tr bgcolor='#D6E7EF'>
				...
				");
                                if ($xtipo_info=="S"):
			echo("
                             <input type='checkbox' name='tipo_info' value='S' checked ><b>VENDEDOR DE MICRO</b>
				");
			else:
			echo("
                             <input type='checkbox' name='tipo_info' value='S' > <b>VENDEDOR DE MICRO </b>
				");
			endif;
			echo("
			...
			<tr bgcolor='#D6E7EF'>
				...
				");
                                if ($xtipo_tecnico=="S"):
			echo("
                             <input type='checkbox' name='tipo_tecnico' value='S' checked ><b> TECNICO DE ASSISTÊNCIA TÉCNICA</b>
				");
			else:
			echo("
                             <input type='checkbox' name='tipo_tecnico' value='S' ><b> TECNICO DE ASSISTÊNCIA TÉCNICA </b>
				");
			endif;
			echo("
						  ...
						  <tr bgcolor='#D6E7EF'>
                            <td width='26%' ><b><font size='1' face='Verdana, Arial, Helvetica, sans-serif' color='#000000'></font></b></td>
                            <td width='74%' colspan ='2'><font color='#FF0000' face='Verdana, Arial, Helvetica, sans-serif' size='1'>
				");
                                if ($xped_bol=="S"):
			echo("
                             <input type='checkbox' name='ped_bol' value='S' checked ><b> PERMITIR PEDIDO COM BOLETA FAT DIRETO</b>
				");
			else:
			echo("
                             <input type='checkbox' name='ped_bol' value='S' ><b> PERMITIR PEDIDO COM BOLETA FAT DIRETO </b>
				");
			endif;
			echo("
  ...
  <tr valign='top'>
    <td><fieldset>
      <legend class='titulos_itens'><strong> COMISS&Atilde;O GARANTIDA SUPERVISOR </strong></legend>
      <table width='100%'  border='0' cellspacing='1' cellpadding='1'>
        <tr>
          <td>MCV PROTEGIDO MAX. </td>
          <td><input name='mcv_prot_max' type='text' size='10' id ='mcv_prot_max' value='$xmcv_prot_max' >
            % </td>
        </tr>
        <tr>
          <td>MCV PROTEGIDO MIN.</td>
          <td><input name='mcv_prot_min' type='text' size='10' id ='mcv_prot_min' value='$xmcv_prot_min' >
            % </td>
        </tr>
        
			<tr>
          <td>INCREMENTO DE MCV MAX.</td>
          <td><input name='mcv_incre' type='text' size='10' id= 'mcv_incre' value='$xmcv_incre' >
            %</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><input type='checkbox' name='meia_mcv_hab' value='S' id= 'meia_mcv_hab' $chk_meiamcv_hab >
          HABILITAR MEIA MCV </td>
        </tr>
      </table>
    </fieldset></td>
  </tr>
...
<table  border='0' cellspacing='2' cellpadding='2' width='80%'>
  <tr valign='top'>
    <td><fieldset>
      <legend class='titulos_itens'><strong> META TELEFONIA CELULAR </strong></legend>
      <table width='100%'  border='0' cellspacing='1' cellpadding='1'>
        <tr>
          <td>PLANO IDEAL </td>
          <td><input name='meta_pi' type='text' size='10' id ='meta_pi'  ></td>
        </tr>
        <tr>
          <td>PLANO CONTROLE</td>
          <td><input name='meta_pc' type='text' size='10' id ='meta_pc'  ></td>
        </tr>
        
			<tr>
          <td>PLANO CARTÃO.</td>
          <td><input name='meta_pcar' type='text' size='10' id= 'meta_pcar'  ></td>
        </tr>
        	<tr>
          <td>FATURAMENTO CARTÃO.</td>
          <td>R$ 
            <input name='meta_pcar_fat' type='text' size='10' id= 'meta_pcar_fat' ></td>
        </tr>
        <tr>
          <td>DATA META </td>
          <td><input name='meta_mes' type='text' id= 'meta_mes' size='2' maxlength='2'>
          /
            <input name='meta_ano' type='text' id= 'meta_ano' size='4' maxlength='4'></td>
        </tr>
      </table>
     <table width='100%' border='0' align='center'>
        <tr align='center'>
          <td width='6%' bgcolor='#CCCCCC'><strong>M&Ecirc;S</strong></td>
          <td width='16%' bgcolor='#CCCCCC'><strong>PI</strong></td>
          <td width='18%' bgcolor='#CCCCCC'><strong>PC</strong></td>
          <td width='19%' bgcolor='#CCCCCC'><strong>PCAR</strong></td>
          <td width='37%' bgcolor='#CCCCCC'><strong>FAT CAR </strong></td>
          <td width='4%' bgcolor='#FFFFFF'>&nbsp;</td>
        </tr>
      ");
			$prod->listProdgeral("vendedor_meta", "codvend = '$codvendold'", $array, $array_campo , "");
	for($i = 0; $i < count($array); $i++ ){
			
			$prod->mostraProd( $array, $array_campo, $i );

			$codmvend = $prod->showcampo0();
			$meta_data = $prod->showcampo2();
			$meta_pi = $prod->showcampo3();
			$meta_pc = $prod->showcampo4();
			$meta_pcar = $prod->showcampo5();
			$meta_pcar_far = $prod->showcampo6();
	
	
			echo("
			        <tr>
          <td align='center'>$meta_data</td>
          <td align='center'>$meta_pi</td>
          <td align='center'>$meta_pc</td>
          <td align='center'>$meta_pcar</td>
          <td align='center'>$meta_pcar_far</td>
          <td align='center'><a href='$PHP_SELF?Action=delete&tipocliente=F&codmvend_select=$codmvend&desloc=$desloc&codempselect=$codempselect&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pg#cliente'>X</a></td>
        </tr>
        ");
	}
	echo("
...
<table  border='0' cellspacing='2' cellpadding='2' width='80%'>
  <tr valign='top'>
    <td><fieldset>
      <legend class='titulos_itens'><strong> SUB LOGIN </strong></legend>
      <table width='100%'  border='0' cellspacing='1' cellpadding='1'>
        <tr>
          <td>LOGIN </td>
          <td><input name='login_user_sub' type='text' size='10' id =login_user_sub'  ></td>
        </tr>
        <tr>
          <td>SENHA</td>
          <td><input name='senha_user_sub' type='text' size='10' id ='senha_user_sub'  ></td>
        </tr>
        
			<tr>
          <td>SUPERVISOR</td>
          <td> <input type='radio' name='tipo_user_sub' value='N' checked > N <input type='radio' name='tipo_user_sub' value='S'  > S</td>
        </tr>
        
      </table>
     <table width='100%' border='0' align='center'>
        <tr align='center'>
          <td width='70%' bgcolor='#CCCCCC'><strong>LOGIN</strong></td>
          <td width='20%%' bgcolor='#CCCCCC'><strong>SUPERVISOR</strong></td>
          
          <td width='10%' bgcolor='#FFFFFF'>&nbsp;</td>
        </tr>
      ");
			$prod->listProdgeral("vendedor_usuario", "codvend = '$codvendold'", $array, $array_campo , "");
	for($i = 0; $i < count($array); $i++ ){
			
			$prod->mostraProd( $array, $array_campo, $i );

			$codmvend = $prod->showcampo0();
			$login_user = $prod->showcampo1();
			$tipo_super = $prod->showcampo3();
	
	
			echo("
			        <tr>
          <td align='center'>$login_user</td>
          <td align='center'>$tipo_super</td>
          
          <td align='center'><a href='$PHP_SELF?Action=delete_sub&tipocliente=F&codmvend_select=$codmvend&desloc=$desloc&codempselect=$codempselect&palavrachave=$palavrachave&operador=$operador&pagina=$pagina&retlogin=$retlogin&connectok=$connectok&pg=$pg#cliente'>X</a></td>
        </tr>
        ");
	}
	echo("
