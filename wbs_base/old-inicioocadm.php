...
<form name='form1' method='post' action='$PHP_SELF?Action=recalc&desloc=0'>
	 ...
	 for($i = 0; $i < count($array3); $i++ ){
			...
			$cb = $prod->showcampo11();
			if ($cb=="OK"){$corcb="#339900";}else{$cb="N";$corcb="#FF0000";}
					  ...
					  <td width='58%'>&nbsp;
                        <table border='0' width='100%' cellspacing='0' cellpadding='2'>
                          <tr>
                            ...
                            <td width='58%'><font size='1' face='Verdana'><b><input class='sbttn' type='submit' name='Submit' value='RECALCULAR VALORES'></b></font>
                            </td>
                          </tr>
                        </table>
                        &nbsp;</td>
