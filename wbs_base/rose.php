...
<br>
<table  border='0' cellpadding='2' cellspacing='2' class='borda'>
<form action='rose.php?acao=login' name='login' method='post'>
  <tr>
    <td>Senha:</td>
...
elseif ($acao == "login")
{
    if ($senha == "ipa321")
    {
        // pega codemp
        $prod->clear();
        $prod->listProdU("codemp_transf","vendedor", "codvend = '49'");
...
<br>
<table  border='0' cellpadding='2' cellspacing='2' class='borda'>
<form action='rose.php?acao=trocar' name='troca' method='post'>
  <tr>
...
elseif ($acao == "trocar")
{
        ...
        // troca
        $prod->clear();
        $prod->upProdU("vendedor", "$condicaoup", "codvend = '49'");
