...
$rs_lista = $db->query_db("SELECT projeto_relacao_custo.opcaixa, descricao, valor, datacc, datavenc, codproj, codcap FROM projeto_relacao_custo, formapg WHERE formapg.opcaixa = projeto_relacao_custo.opcaixa $cond AND datacc LIKE '$ano-$mes%' and projeto_relacao_custo.opcaixa <> '60.01' and projeto_relacao_custo.opcaixa <> '60.02' and projeto_relacao_custo.opcaixa <> '60.04' and projeto_relacao_custo.opcaixa <> '100.02' and projeto_relacao_custo.opcaixa <> '100.12' and projeto_relacao_custo.opcaixa <> '100.06' and projeto_relacao_custo.opcaixa <> '800.98' and projeto_relacao_custo.opcaixa <> '830.01' and projeto_relacao_custo.opcaixa <> '100.13' and projeto_relacao_custo.opcaixa = '$opcaixa' and despesa = 'OP' ORDER BY descricao","SQL_NONE","N");
