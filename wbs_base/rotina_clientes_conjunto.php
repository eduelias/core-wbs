...
");
		...
		$prod->listProdSum("codbarra, pedido.codcliente, nome, dddtel1, tel1, dddtel2, tel2, cidade, pedido.codped", "pedido, clientenovo", "pedido.codcliente = clientenovo.codcliente AND cidade LIKE  '%juiz%' AND dataped >=  '$ano-$mes-01' and dataped <= '$ano-$mes-31' and pedido.codcliente <> 5550 and pedido.codcliente <> 1708 and pedido.codcliente <> 323 and pedido.codcliente <> 5034 and tipocliente = 'F'", $array, $array_campo, "ORDER BY nome");
		...
		for($i = 0; $i < count($array); $i++ ){
			...
			$prod->clear();
			$prod->listProdU("COUNT(*)","pedidoprod, produtos", "codped='$codped' and (tipoprod = 'CJ' or codcat = 73) and pedidoprod.codprod=produtos.codprod ");
