...
switch ($modelo)
  {
			 ...
			 case "3061":
			  ...
			  $codprod_m[3] = "3467";	$lib_imp[3] = 0;	//GABINETE
			  #$codprod_m[4] = "2293";	$lib_imp[4] = 0;	//TECLADO
			  #$codprod_m[5] = "2297";	$lib_imp[5] = 0;	//MOUSE
			  #$codprod_m[7] = "3032";	$lib_imp[7] = 0;	//CAIXA SOM
			  #$codprod_m[4] = "2245";	$lib_imp[4] = 1;	//CD/DVD
			...
			case "2582":
			  ...
			  $codprod_m[3] = "2309";	$lib_imp[3] = 0;	//GABINETE // padrao 2309
			  #$codprod_m[5] = "2293";	$lib_imp[5] = 0;	//TECLADO
			  #$codprod_m[6] = "2297";	$lib_imp[6] = 0;	//MOUSE
			  #$codprod_m[7] = "3032";	$lib_imp[7] = 0;	//CAIXA SOM
			  $codprod_m[4] = "2790";	$lib_imp[4] = 1;	//CD/DVD
			  $codprod_m[5] = "1421";	$lib_imp[5] = 0;	//FAX
			  $codprod_m[6] = "2747";	$lib_imp[6] = 0;	//PL MAE
			  #$codprod_m[7] = "3084";	$lib_imp[7] = 0;	//FONTE
			 ...
			 case "2599":
			  ...
			  case "2718":
    			// MODELO MAXX-PC MD02
			  $codprod_m[0] = "3497";   	$lib_imp[0] = 1;	//PROCESSADOR 
			  #$codprod_m[1] = "1516";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2691";    	$lib_imp[1] = 1;	//MEMORIA  
			  $codprod_m[2] = "2791";	$lib_imp[2] = 1;	//HD
			  $codprod_m[3] = "2309";	$lib_imp[3] = 0;	//GABINETE // padrao 2309
    		...
    		// MODELO MAXX-PC RMC02
			  $codprod_m[0] = "2967";   	$lib_imp[0] = 1;	//PROCESSADOR
			  #$codprod_m[1] = "1516";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2691";    	$lib_imp[1] = 1;	//MEMORIA //2593
    		...
    		// MODELO MAXX-PC RMC03
			  ...
			  #$codprod_m[1] = "1516";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2691";    	$lib_imp[1] = 1;	//MEMORIA
			  $codprod_m[2] = "2368";	$lib_imp[2] = 1;	//HD 80 gb
			  $codprod_m[3] = "2871";	$lib_imp[3] = 0;	//GABINETE // padrao 2309
			  $codprod_m[4] = "2293";	$lib_imp[4] = 0;	//TECLADO
			  $codprod_m[5] = "2297";	$lib_imp[5] = 0;	//MOUSE
			  ...
			  $codprod_m[8] = "2747";	$lib_imp[8] = 0;	//PL MAE
			  #$codprod_m[9] = "3084";	$lib_imp[9] = 0;	//FONTE
    		...
    		// MODELO MAXX-PC RMC04
			  ...
			  $modelo_prod = "3185";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =1;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC RMC04";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
			 			
			  break;	
			  
			    case "3477":
    		// MODELO MAXX-PC RMC04N
			  $codprod_m[0] = "2967";   	$lib_imp[0] = 1;	//PROCESSADOR
			  #$codprod_m[1] = "1516";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2691";    	$lib_imp[1] = 1;	//MEMORIA
			  $codprod_m[2] = "2791";	$lib_imp[2] = 1;	//HD  
			  $codprod_m[3] = "3467";	$lib_imp[3] = 0;	//GABINETE // padrao 3467 - 2 baias
			  $codprod_m[4] = "2293";	$lib_imp[4] = 0;	//TECLADO
			  $codprod_m[5] = "2297";	$lib_imp[5] = 0;	//MOUSE
			  $codprod_m[6] = "2296";	$lib_imp[6] = 0;	//CAIXA SOM
			  $codprod_m[7] = "2790";	$lib_imp[7] = 1;	//CD/DVD
			  #$codprod_m[8] = "1421";	$lib_imp[8] = 0;	//FAX  // PADRAO SEM MODEM
			  $codprod_m[8] = "3675";	$lib_imp[8] = 0;	//PL MAE padrao 2747
			  $codprod_m[9] = "1397";	$lib_imp[9] = 0;	//FONTE
			  
			
			  $modelo_prod = "3477";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =1;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC RMC04N";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
    		...
    		// MODELO MAXX-PC RM001
			  ...
			  break; 
			    ...
			    case "3440":
    		// MODELO MAXX-PC RMC05
			  $codprod_m[0] = "2967";   	$lib_imp[0] = 1;	//PROCESSADOR
			  #$codprod_m[1] = "1516";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2942";    	$lib_imp[1] = 1;	//MEMORIA
			  $codprod_m[2] = "3239";	$lib_imp[2] = 1;	//HD 320 gb
			  $codprod_m[3] = "2309";	$lib_imp[3] = 0;	//GABINETE // padrao 2309
			  $codprod_m[4] = "2293";	$lib_imp[4] = 0;	//TECLADO
			  $codprod_m[5] = "2297";	$lib_imp[5] = 0;	//MOUSE
			  $codprod_m[6] = "2296";	$lib_imp[6] = 0;	//CAIXA SOM		
			  ...
			  $modelo_prod = "3440";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =1;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC RMC05";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
    		...
    		// MODELO MAXX-PC RME02
			  $codprod_m[0] = "2495";   	$lib_imp[0] = 1;	//PROCESSADOR  // padrao: 2968
			  #$codprod_m[1] = "1516";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2942";    	$lib_imp[1] = 1;	//MEMORIA
			  $codprod_m[2] = "3239";	$lib_imp[2] = 1;	//HD
			  $codprod_m[3] = "2309";	$lib_imp[3] = 0;	//GABINETE
			  $codprod_m[4] = "2293";	$lib_imp[4] = 0;	//TECLADO
			  $codprod_m[5] = "2297";	$lib_imp[5] = 0;	//MOUSE
			  $codprod_m[6] = "3032";	$lib_imp[6] = 0;	//CAIXA SOM
    		...
    		// MODELO MAXX-PC RME03I
			  ...
			  $codprod_m[7] = "2790";	$lib_imp[7] = 1;	//CD/DVD
			  #$codprod_m[5] = "1421";	$lib_imp[8] = 0;	//FAX
			  $codprod_m[8] = "3673";	$lib_imp[8] = 0;	//PL MAE  // PADRAO PLACA INTEL
			  #$codprod_m[9] = "3084";	$lib_imp[9] = 0;	//FONTE	
			  
			
			  $modelo_prod = "3454";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =1;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC RME03I";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
    		...
    		// MODELO MAXX-PC RME04
			  ...
			  break;	
			   ...
			   case "3576":
    		// MODELO MAXX-PC RME04P
			  $codprod_m[0] = "3500";   	$lib_imp[0] = 1;	//PROCESSADOR   
			  #$codprod_m[1] = "1516";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2942";    	$lib_imp[1] = 1;	//MEMORIA // 2942 padrao 1 de 2gb
			  #$codprod_m[2] = "2691";    	$lib_imp[2] = 1;	//MEMORIA
			  $codprod_m[2] = "3392";	$lib_imp[2] = 1;	//HD	320
			  $codprod_m[3] = "2309";	$lib_imp[3] = 0;	//GABINETE // padrao 2309
			  $codprod_m[4] = "2293";	$lib_imp[4] = 0;	//TECLADO
			  $codprod_m[5] = "2297";	$lib_imp[5] = 0;	//MOUSE
			  $codprod_m[6] = "2296";	$lib_imp[6] = 0;	//CAIXA SOM
			  ...
			  $modelo_prod = "3576";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =1;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC RME04P";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
    		...
    		// MODELO MAXX-PC RMQ01
			  $codprod_m[0] = "3498";   	$lib_imp[0] = 1;	//PROCESSADOR
			  #$codprod_m[1] = "1516";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2942";    	$lib_imp[1] = 1;	//MEMORIA
			  $codprod_m[2] = "2942";    	$lib_imp[2] = 1;	//MEMORIA
			  $codprod_m[3] = "3392";	$lib_imp[3] = 1;	//HD 500
			  $codprod_m[4] = "2309";	$lib_imp[4] = 0;	//GABINETE // padrao 2309
			  $codprod_m[5] = "2293";	$lib_imp[5] = 0;	//TECLADO
			  $codprod_m[6] = "2297";	$lib_imp[6] = 0;	//MOUSE
			  ...
			  #$codprod_m[10] = "3084";	$lib_imp[10] = 0;	//FONTE 
    		...
    		// MODELO MAXX-PC RMS03 SEMPROM
			  ...
			  $codprod_m[2] = "2691";    	$lib_imp[2] = 1;	//MEMORIA 
			  #$codprod_m[2] = "2691";    	$lib_imp[2] = 1;	//MEMORIA
			  $codprod_m[3] = "2792";	$lib_imp[3] = 1;	//HD	
			  ...
			  $codprod_m[8] = "2790";	$lib_imp[8] = 1;	//CD/DVD
			  #$codprod_m[5] = "1421";	$lib_imp[8] = 0;	//FAX
			  #$codprod_m[9] = "2747";	$lib_imp[9] = 0;	//PL MAE  // 2747
			  #$codprod_m[9] = "1397";	$lib_imp[9] = 0;	//FONTE
			  ...
			  break;	
			    ...
			    case "3451":
    		// MODELO MAXX-PC RMS04 SEMPROM
			  $codprod_m[0] = "3532";   	$lib_imp[0] = 1;	//PROCESSADOR 
			  #$codprod_m[1] = "3110";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2691";    	$lib_imp[1] = 1;	//MEMORIA 
			  #$codprod_m[2] = "2691";    	$lib_imp[2] = 1;	//MEMORIA
			  $codprod_m[2] = "2791";	$lib_imp[2] = 1;	//HD 160	
			  $codprod_m[3] = "2309";	$lib_imp[3] = 0;	//GABINETE
			  $codprod_m[4] = "2293";	$lib_imp[4] = 0;	//TECLADO
			  $codprod_m[5] = "2297";	$lib_imp[5] = 0;	//MOUSE
			  $codprod_m[6] = "2296";	$lib_imp[6] = 0;	//CAIXA SOM
			  $codprod_m[7] = "2790";	$lib_imp[7] = 1;	//CD/DVD
			  #$codprod_m[5] = "1421";	$lib_imp[8] = 0;	//FAX
			  $codprod_m[8] = "3455";	$lib_imp[8] = 0;	//PL MAE  AMD
			  #$codprod_m[9] = "1397";	$lib_imp[9] = 0;	//FONTE
			  #$codprod_m[8] = "1432";	$lib_imp[8] = 1;	//DRIVE 1.44
			  
			
			  $modelo_prod = "3451";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =1;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC RMS04";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
			 			
			  break;	
			  
			    case "3453":
    		// MODELO MAXX-PC RMS05 SEMPROM
			  $codprod_m[0] = "3532";   	$lib_imp[0] = 1;	//PROCESSADOR  
			  #$codprod_m[1] = "3110";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2942";    	$lib_imp[1] = 1;	//MEMORIA 
			  #$codprod_m[2] = "2691";    	$lib_imp[2] = 1;	//MEMORIA
			  ...
			  $modelo_prod = "3453";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =1;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC RMS05";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
			 			
			  break;	
			  
			   case "3464":
    		// MODELO MAXX-PC RMS06 SEMPROM
			  $codprod_m[0] = "3532";   	$lib_imp[0] = 1;	//PROCESSADOR  
			  #$codprod_m[1] = "3110";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2942";    	$lib_imp[1] = 1;	//MEMORIA 
			  #$codprod_m[2] = "2691";    	$lib_imp[2] = 1;	//MEMORIA
			  ...
			  $modelo_prod = "3464";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =1;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC RMS06";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
			 			
			  break;	
			  
			  case "3465":
    		// MODELO MAXX-PC MD03S 
			  $codprod_m[0] = "3497";   	$lib_imp[0] = 1;	//PROCESSADOR  
			  #$codprod_m[1] = "3110";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2942";    	$lib_imp[1] = 1;	//MEMORIA 
			  #$codprod_m[2] = "2691";    	$lib_imp[2] = 1;	//MEMORIA
			  ...
			  #$codprod_m[7] = "2790";	$lib_imp[7] = 1;	//CD/DVD
			  #$codprod_m[5] = "1421";	$lib_imp[8] = 0;	//FAX
			  $codprod_m[4] = "2747";	$lib_imp[4] = 0;	//PL MAE  AMD
			  $codprod_m[5] = "1397";	$lib_imp[5] = 0;	//FONTE
			  #$codprod_m[8] = "1432";	$lib_imp[8] = 1;	//DRIVE 1.44
			  
			
			  $modelo_prod = "3465";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =0;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC MD03S";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
			  ...
			  break;	
			   ...
			   case "3452":
    		// MODELO MAXX-PC RMT03
			  $codprod_m[0] = "3531";   	$lib_imp[0] = 1;	//PROCESSADOR 
			  #$codprod_m[1] = "3110";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2942";    	$lib_imp[1] = 1;	//MEMORIA 
			  #$codprod_m[2] = "2691";    	$lib_imp[2] = 1;	//MEMORIA
			  $codprod_m[2] = "3239";	$lib_imp[2] = 1;	//HD 320	
			  ...
			  $modelo_prod = "3452";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =1;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC RMT03";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
			  ...
			  break;	
			    ...
			    case "3479":
    		// MODELO MAXX-PC RMP04 SEMPROM
			  $codprod_m[0] = "3473";   	$lib_imp[0] = 1;	//PROCESSADOR  
			  #$codprod_m[1] = "3110";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2942";    	$lib_imp[1] = 1;	//MEMORIA 
			  $codprod_m[2] = "2942";    	$lib_imp[2] = 1;	//MEMORIA
			  $codprod_m[3] = "3392";	$lib_imp[3] = 1;	//HD 320	
			  $codprod_m[4] = "2309";	$lib_imp[4] = 0;	//GABINETE
			  $codprod_m[5] = "2293";	$lib_imp[5] = 0;	//TECLADO
			  $codprod_m[6] = "2297";	$lib_imp[6] = 0;	//MOUSE
			  $codprod_m[7] = "2296";	$lib_imp[7] = 0;	//CAIXA SOM
			  $codprod_m[8] = "2790";	$lib_imp[8] = 1;	//CD/DVD
			  #$codprod_m[5] = "1421";	$lib_imp[8] = 0;	//FAX
			  $codprod_m[9] = "3455";	$lib_imp[9] = 0;	//PL MAE  AMD
			  #$codprod_m[9] = "1397";	$lib_imp[9] = 0;	//FONTE
			  #$codprod_m[8] = "1432";	$lib_imp[8] = 1;	//DRIVE 1.44
			  
			
			  $modelo_prod = "3479";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =1;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC RMP04";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
		 ...
		 case "3161": 
    		// MODELO MAXX-PC RMX01 
			  ...
			  #$codprod_m[9] = "1397";	$lib_imp[9] = 0;	//FONTE
			  #$codprod_m[8] = "1432";	$lib_imp[8] = 1;	//DRIVE 1.44
			  #$codprod_m[9] = "3431";	$lib_imp[9] = 1;	//WINDOWS LICENCA STARTER
			  #$codprod_m[10] = "3430";	$lib_imp[10] = 0;	//WINDOWS MIDIA
			  #$codprod_m[11] = "3432";	$lib_imp[11] = 0;	//WINDOWS LITERATURA
			  #$codprod_m[13] = "2605";	$lib_imp[13] = 1;	//LEITOR CARTAO
			  #$codprod_m[12] = "3305";	$lib_imp[12] = 1;	//FONTE REAL
			     
			 
			  $modelo_prod = "3161";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =1;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC RMX01";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
			 			
			  break;
			  
			    case "3535": 
    		// MODELO MAXX-PC EXT01 EXTREME 
			  $codprod_m[0] = "3531";   	$lib_imp[0] = 1;	//PROCESSADOR
			  #$codprod_m[1] = "1516";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2942";    	$lib_imp[1] = 1;	//MEMORIA
			  $codprod_m[2] = "2942";    	$lib_imp[2] = 1;	//MEMORIA
			  $codprod_m[3] = "3392";	$lib_imp[3] = 1;	//HD
			  $codprod_m[4] = "3524";	$lib_imp[4] = 0;	//GABINETE // padrao 3524
			  #$codprod_m[5] = "2293";	$lib_imp[5] = 0;	//TECLADO
			  #$codprod_m[6] = "2297";	$lib_imp[6] = 0;	//MOUSE
			  #$codprod_m[7] = "2296";	$lib_imp[7] = 0;	//CAIXA SOM
			  $codprod_m[5] = "2790";	$lib_imp[5] = 1;	//CD/DVD
			  #$codprod_m[8] = "1421";	$lib_imp[8] = 0;	//FAX
			  $codprod_m[6] = "3455";	$lib_imp[6] = 0;	//PL MAE
			  #$codprod_m[9] = "3431";	$lib_imp[9] = 1;	//WINDOWS LICENCA STARTER
			  #$codprod_m[10] = "3430";	$lib_imp[10] = 0;	//WINDOWS MIDIA
			  #$codprod_m[11] = "3432";	$lib_imp[11] = 0;	//WINDOWS LITERATURA
			  $codprod_m[7] = "2605";	$lib_imp[7] = 1;	//LEITOR CARTAO
			  #$codprod_m[12] = "3305";	$lib_imp[12] = 1;	//FONTE REAL
			     
			 
			  $modelo_prod = "3535";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =0;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC EXT01";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
			  ...
			  case "3522": 
    		// MODELO MAXX-PC EXT02 EXTREME 
			  $codprod_m[0] = "3750";   	$lib_imp[0] = 1;	//PROCESSADOR
			  #$codprod_m[1] = "1516";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[1] = "2942";    	$lib_imp[1] = 1;	//MEMORIA
			  $codprod_m[2] = "2942";    	$lib_imp[2] = 1;	//MEMORIA
			  $codprod_m[3] = "3392";	$lib_imp[3] = 1;	//HD
			  $codprod_m[4] = "3523";	$lib_imp[4] = 0;	//GABINETE // padrao 3523
			  #$codprod_m[5] = "2293";	$lib_imp[5] = 0;	//TECLADO
			  #$codprod_m[6] = "2297";	$lib_imp[6] = 0;	//MOUSE
			  #$codprod_m[7] = "2296";	$lib_imp[7] = 0;	//CAIXA SOM
			  $codprod_m[5] = "2790";	$lib_imp[5] = 1;	//CD/DVD
			  ...
			  $modelo_prod = "3522";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =0;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC EXT02";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
			 			
			  break;
			  	
			 case "3540": 
    		// MODELO MAXX-PC ECO01 
			  #$codprod_m[0] = "3473";   	$lib_imp[0] = 1;	//PROCESSADOR
			  #$codprod_m[1] = "1516";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[0] = "2942";    	$lib_imp[0] = 1;	//MEMORIA
			  #$codprod_m[2] = "2942";    	$lib_imp[2] = 1;	//MEMORIA
			  $codprod_m[1] = "2791";	$lib_imp[1] = 1;	//HD
			  #$codprod_m[4] = "3523";	$lib_imp[4] = 0;	//GABINETE // padrao 3523
			  #$codprod_m[5] = "2293";	$lib_imp[5] = 0;	//TECLADO
			  #$codprod_m[6] = "2297";	$lib_imp[6] = 0;	//MOUSE
			  #$codprod_m[7] = "2296";	$lib_imp[7] = 0;	//CAIXA SOM
			  #$codprod_m[5] = "2790";	$lib_imp[5] = 1;	//CD/DVD
			  #$codprod_m[8] = "1421";	$lib_imp[8] = 0;	//FAX
			  $codprod_m[2] = "3539";	$lib_imp[2] = 1;	//BAREBONE
			  
			     
			 
			  $modelo_prod = "3540";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =0;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC ECO01";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
    		...
    		// MODELO MAXX-PC ECO02 
			  ...
			  $codprod_m[1] = "2791";	$lib_imp[1] = 1;	//HD
			  #$codprod_m[4] = "3523";	$lib_imp[4] = 0;	//GABINETE // padrao 3523
			  $codprod_m[2] = "2293";	$lib_imp[2] = 0;	//TECLADO
			  $codprod_m[3] = "2297";	$lib_imp[3] = 0;	//MOUSE
			  $codprod_m[4] = "2296";	$lib_imp[4] = 0;	//CAIXA SOM
			  $codprod_m[5] = "2790";	$lib_imp[5] = 1;	//CD/DVD
			  #$codprod_m[8] = "1421";	$lib_imp[8] = 0;	//FAX
			  $codprod_m[6] = "3539";	$lib_imp[6] = 1;	//BAREBONE
			  $codprod_m[7] = "2605";	$lib_imp[7] = 1;	//LEITOR CARTAO
			  
			     
			 
			  $modelo_prod = "3542";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =1;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC ECO02";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
			 ...
			 case "3668": 
    		// MODELO MAXX-PC ECO03 
			  #$codprod_m[0] = "3473";   	$lib_imp[0] = 1;	//PROCESSADOR
			  #$codprod_m[1] = "1516";    	$lib_imp[1] = 0;	//COOLER
			  $codprod_m[0] = "2942";    	$lib_imp[0] = 1;	//MEMORIA
			  #$codprod_m[2] = "2942";    	$lib_imp[2] = 1;	//MEMORIA
			  $codprod_m[1] = "2791";	$lib_imp[1] = 1;	//HD
			  $codprod_m[2] = "3467";	$lib_imp[2] = 0;	//GABINETE // padrao 3523
			  $codprod_m[3] = "2293";	$lib_imp[3] = 0;	//TECLADO
			  $codprod_m[4] = "2297";	$lib_imp[4] = 0;	//MOUSE
			  $codprod_m[5] = "2296";	$lib_imp[5] = 0;	//CAIXA SOM
			  $codprod_m[6] = "2790";	$lib_imp[6] = 1;	//CD/DVD
			  #$codprod_m[8] = "1421";	$lib_imp[8] = 0;	//FAX
			  $codprod_m[7] = "3666";	$lib_imp[7] = 1;	//PROCESSADOR + PLACA MAE
			  #$codprod_m[7] = "2605";	$lib_imp[7] = 1;	//LEITOR CARTAO'
			  $codprod_m[8] = "1397";	$lib_imp[8] = 0;	//FONTE
			  
			     
			 
			  $modelo_prod = "3668";						 // COD PRODUTO
			  $soft = 0;  									 // 0 - SEM SOFTWARE, 1 - COM SOFTWARE
			  $fax = 0;  									 // 0 - SEM FAX MODEM, 1 - COM FAX MODEM
			  $cor =1;    									 // 0 - BRANCO, 1 - PRETO
			  $perif =1;    									 // 0 - SEM PERIFERICOS, 1 - COM PERIFERICOS
			  $descr = "MAXX-PC ECO03";  	 			// DESCRICAO MICRO
			  $monitor = 0;									 // 0 - SEM MONITOR, 1 - COM MONITOR
		...
		case "2350":
			...
			case "2491":
			 ...
			 case "2751":
			  ...
			  #$codprod_m[7] = "2790";	$lib_imp[7] = 1;	//CD/DVD
			  #$codprod_m[8] = "1421";	$lib_imp[8] = 0;	//FAX
			  $codprod_m[4] = "2851";	$lib_imp[4] = 0;	//PL MAE
