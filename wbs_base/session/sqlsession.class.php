...
class sqlSession
{
	...
	*/
	function begin_session()
	{
		...
		SetCookie("session", $sesscode, time()+36000, "/", "wbs.ipasoft.com.br", 0);
	...
	*/
	function user_logged_in()
	{
		...
		#			WHERE id='$this->session'");
		$result = $this->db->query("SELECT userID 
					FROM $this->session_table 
					WHERE id='$this->session'");
