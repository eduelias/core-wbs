...
based on b2bookmarklet.php from b2, copyright Michel Valdrighi.

put this in your b2 directory
...
<body topmargin="0" leftmargin="0" marginheight="0" mardingwidth="0" style="margin: 0px;">

<table width="100%" style="background: #ccc;" border="0">
	<tr>
		<td>&nbsp;</td>
	</tr>
</table>
...
<input type="text" name="post_title" size="20" tabindex="1" style="width: 215px;" value="<?php echo stripslashes($_REQUEST["task_title"]); ?>" /></td>
...
<textarea rows="20" cols="48" style="width:415px;" name="content" tabindex="2" class="postform"><?php echo stripslashes($_REQUEST["task_notes"]); ?></textarea><br />
...
<?php if ($use_ljupdate) { ?>
<td align="left">
<input type="checkbox" class="checkbox" name="post_ljupdate" value="1" <?php $fljuchk = $lju_post ? 'checked="checked"' : ''; echo $fljuchk; ?> tabindex="8" id="ljupdate" /><label for="ljupdate"> Update my LiveJournal </label>
</td>
<?php } ?>
</table>
