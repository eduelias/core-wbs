...
$language->about = array("tagline" => "keep stuff organized and get it done."
                        ...
                        ,"latest_version" => "Última Edição Versão: __0" // number
                        ,"beta_version" => "Última Edição Beta: __0" // number
                        ,"using_latest" => "Está a utilizar a última versão disponível."
                        ,"using_beta" => "Está a utilizar a última versão beta disponível."
                        ,"feedback" => "Opiniões e Sugestões:"
                        ,"web" => "Web:"
                        ,"credits" => "Créditos"
                        ,"main_credit" => "Tasks Jr. é um conceito e criação de <nobr>Alex King</nobr>. Foi traduzido para os seguintes idiomas pelos generosos indivíduos que se seguem:"
                        ,"web_site" => "página na internet"
...
$language->breadcrumbs = array("history" => "História"
                              ,"home" => "Home"
...
$language->confirm = array("complete_instructions" => "A tarefa que marcou como terminada tem __0 open sub-task(s). Por favor escolha como continuar" // number
                          ,"complete_orphan" => "Marque esta farefa como completa e defina a(s) sua(s) sub-tarefa(s) como não tendo PARENT"
                          ...
                          ,"delete_remove" => "Apague esta tarefa e anexe a(s) sua(s) sub-tarefa(s) a sua tarefa mãe"
                          ,"delete_title" => "Apagar as opções de tarefa"
