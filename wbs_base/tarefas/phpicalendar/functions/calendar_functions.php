...
// adding Tasks web cal, Alex King http://www.alexking.org/

if ($ak_add_tasks_cal == 'yes') {

	if (isset($_SERVER['PHP_AUTH_USER']) && isset($_SERVER['PHP_AUTH_PW'])) {
		$tasks_cal = "http://".$_SERVER['PHP_AUTH_USER'].':'.$_SERVER['PHP_AUTH_PW'].'@'
					.preg_replace("/phpicalendar\/.*/"
								 ,''
	...
	array_push($calendars, $tasks_cal);
