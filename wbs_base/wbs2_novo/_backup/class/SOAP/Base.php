...
// +----------------------------------------------------------------------+
//
// $Id: Base.php,v 1.40.2.4 2004/01/17 14:22:58 arnaud Exp $
//
...
if (!INF) define('INF',   1.8e307);
if (!NAN) define('NAN',   0.0);
...
*
* @access   public
* @version  $Id: Base.php,v 1.40.2.4 2004/01/17 14:22:58 arnaud Exp $
* @package  SOAP::Client
