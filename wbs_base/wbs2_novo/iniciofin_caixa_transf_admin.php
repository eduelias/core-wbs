...
switch ($Action) {
    ...
    case "update":
	 ...
	 case "fechar":
		...
		if ($codcxsaldoselect <> "" or $codcxsaldoselect <> 0){
	 ...
	 for($i = 0; $i < count($array); $i++ ){
	  ...
	  //INSERE NO CAIXA SAIDA DE DINHEIRO
		...
		$erro_transf = "<font color = '#CC0000'>Ocorreu um erro na Transferência.</font>";
		$Action = "update";
		}
...
<br>
<center><b>$erro_transf</b></center><BR>
...
<br><br>
 <div align='center'>
    ...
    <table border='0' width='550' cellspacing='0' cellpadding='2'>
      <tr>
        <td width='100%' align='center'><input class='sbttn' type='submit' value='Transferir caixa' name='B1'><br></td>
      </tr>
    </table>
    </center>
  </div>
