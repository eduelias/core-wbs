...
function openCalendar(params, form, field, type) {
    window.open("calendar.php?" + params, "calendar", "width=200,height=200,status=yes");
...
function initCalendar() {
    ...
    if (window.opener.dateType != 'date' && !clock_set) {
        ...
        str += '<input class="clock2" id="hour"    type="text" size="2" maxlength="2" onblur="this.value=formatNum2(this.value, \'hour\')" value="' + formatNum2(hour, 'hour') + '" />:';
        str += '<input class="clock2" id="minute"  type="text" size="2" maxlength="2" onblur="this.value=formatNum2(this.value, \'minute\')" value="' + formatNum2(minute, 'minute') + '" />:';
        str += '<input class="clock2" id="second"  type="text" size="2" maxlength="2" onblur="this.value=formatNum2(this.value, \'second\')" value="' + formatNum2(second, 'second') + '" />';
        str += '</form>';
