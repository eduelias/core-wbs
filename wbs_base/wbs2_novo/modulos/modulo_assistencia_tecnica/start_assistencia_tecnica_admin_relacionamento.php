...
$rs_lista = $db->query_db("SELECT * FROM os_at_srv_exec WHERE hist = 'N' ORDER BY descricao","SQL_NONE","N");

$numRows = $rs_lista->_numOfRows;

$rs_laudos = $db->query_db("SELECT * FROM os_at_laudos WHERE hist = 'N' ORDER BY descricao","SQL_NONE","N");
$rs_srv_exec = $db->query_db("SELECT * FROM os_at_srv_exec WHERE hist = 'N' ORDER BY descricao","SQL_NONE","N");
