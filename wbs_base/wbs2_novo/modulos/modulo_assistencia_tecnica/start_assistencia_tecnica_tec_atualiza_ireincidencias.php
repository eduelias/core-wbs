...
$rs_reincidencias = $db->query_db("SELECT * FROM os_at WHERE codcliente = '".$rs_cliente->fields['codcliente']."' AND codos_at <> '$codos_at_select'","SQL_NONE","N");

$db->disconnect();

include ("templates/assistencia_tecnica_tec_atualiza_ireincidencias.htm");
