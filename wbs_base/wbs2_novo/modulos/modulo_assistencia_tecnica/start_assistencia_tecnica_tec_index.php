...
$rs_lista = $db->query_db("SELECT codos_at, codbarra_os_at, nome, codtecnico, dataos_at_ini, status, caixa, os_lib FROM os_at, clientenovo WHERE $condicaopesq clientenovo.codcliente = os_at.codcliente and os_at.codvend = '$codvend' ORDER BY dataos_at_ini DESC LIMIT $inicio_pesq, $acrescimo","SQL_NONE","N");
