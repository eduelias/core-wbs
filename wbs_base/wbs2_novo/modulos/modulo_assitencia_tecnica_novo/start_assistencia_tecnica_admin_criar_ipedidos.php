...
switch ($Action)
{
    ...
    case "PesquisarA":
            ...
            $rs_lista = $db->query_db("SELECT codped, codbarra, nome, dataped FROM pedido, clientenovo WHERE codbarra ='$codpedpesq' AND pedido.codcliente = clientenovo.codcliente","SQL_NONE","N");
	...
	case "PesquisarB":
            ...
            if (($nomeclientepesq <> "") AND ($codbarrapecapesq <> ""))
            {
                ...
                $rs_lista = $db->query_db("SELECT * FROM codbarra, pedido, clientenovo WHERE $condicaopesq pedido.codcliente = clientenovo.codcliente AND pedido.codped = codbarra.codped","SQL_NONE","N");
...
include ("templates/assistencia_tecnica_admin_criar_ipedidos.htm");
