...
switch ($Action)
{
    case "Criar" :
        ...
        // grava
        $rs_grava = $db->query_db("INSERT INTO os_at_temp (codemp, codcliente, codvend, codped, codbarra_ped, codtipo_serv, hist, status, dataos_at_ini) VALUES ('1', '".$rs_pedido->fields['codcliente']."', '".$rs_pedido->fields['codvend']."', '$codped_select', '".$rs_pedido->fields['codbarra']."', '1', 'N', 'ABERTO', '".$db->datahoraatual()."')","SQL_NONE","N");
...
// INICIO TMP
$rs_tmp0 = $db->query_db("SELECT codcliente, codvend FROM os_at_temp WHERE codos_at = '$codos_at_select'","SQL_NONE","N");
