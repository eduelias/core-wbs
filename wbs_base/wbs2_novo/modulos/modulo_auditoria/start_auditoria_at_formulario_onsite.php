...
switch ($Action)
{
    	...
    	case "Pesquisar" :
			...
			if ($resp1[$codperg] == "SE"){$resp[$codperg] = "R: Superou suas Expectativas";}
			if ($resp1[$codperg] == "E"){$resp[$codperg] = "R: Atendeu suas Expectativas";}
			if ($resp1[$codperg] == "N" and ($codperg == 30)){$resp[$codperg] = "R: Não atendeu";}
            ...
            {
                 include ("templates/auditoria_at_formulario_onsite.html");
            }
