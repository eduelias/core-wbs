...
+--------------------------------------------------------------
|  arquivo:     start_cad_view_usuario_juridica.php
|  template:    cad_view_usuario_juridica.htm
+--------------------------------------------------------------
*/
...
switch ($Action) {
    ...
    case "Gravar" :
        ...
        if ($tipogravar == "UPDATE")
        {
			...
			if ($frmInscEst == "ISENTO" or $frmInscEst == "isento" ){
...
include ("templates/cad_view_usuario_juridica.htm");
