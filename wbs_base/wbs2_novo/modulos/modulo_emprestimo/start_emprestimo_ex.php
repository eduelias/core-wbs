...
switch ($Action)
{
	...
	if ($rs_result->fields['codcb']){
		 ...
		 $rs_emprestimo = $db->query_db("UPDATE codbarra SET dataemprestimo = '', login_est =  '', login_vend = '', emprestimo = 'NO' WHERE codcb = '".$rs_result->fields['codcb']."'" ,"SQL_NONE","N");
...
include ("templates/emprestimo_page_ex.htm");
