...
if (($var_codgrp == 32 or $var_codgrp == 51 or $var_codgrp = 56 or $var_codgrp == 53) and $var_codemp_transf <> 0){$condicao_transf = "codemp = '$var_codemp_transf'";}else{$condicao_transf = "";}
