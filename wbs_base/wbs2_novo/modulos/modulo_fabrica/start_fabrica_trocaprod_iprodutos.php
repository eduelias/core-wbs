...
switch ($Action)
  {
    case "Verificar":
      ...
      $rs_prod_ant = $db->query_db("SELECT codcb, codbarra.codprod, nomeprod, idop_prod FROM codbarra, produtos WHERE codbarra.codbarra ='".$codbarra_ant."' and idop_sn ='".$_POST['idop_sn']."' and codemp = '".$codemp_op."' and produtos.codprod= codbarra.codprod","SQL_NONE","N");
      ...
      echo "ne=".$_POST['idop_sn']. " d=". $num_row_ant." idop_prod=".$rs_prod_ant->fields['idop_prod'] ;
      #echo "e".$num_existe;
	...
	case "Modificar":
		...
		$rs_atualiza = $db->query_db("UPDATE codbarra SET codbarraped = 0, idop_sn = 0, idop_prod = 0 WHERE codcb ='".$_POST['codcb_ant']."'","SQL_NONE","N");
		
		$rs_atualiza = $db->query_db("UPDATE codbarra SET codbarraped = 1, idop_sn = '".$_POST['idop_sn']."', idop_prod = '".$_POST['idop_prod']."' WHERE codcb ='".$_POST['codcb_novo']."'","SQL_NONE","S");
...
include ("templates/fabrica_trocaprod_iprodutos.html");
