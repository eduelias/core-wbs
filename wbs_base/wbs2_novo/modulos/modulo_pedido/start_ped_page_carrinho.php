...
$prod->clear();
$prod->listProdSum("tipoprod, pedidoprodtemp.qtde, (pvacj*fatorata*$fatorusertabela), (pva*fatorata*$fatorusertabela), (pvvcj*fatorvar*$fatorusertabela),(pvv*fatorvar*$fatorusertabela), codplano, descplano, pedidoprodtemp.codprod", "pedidoprodtemp, produtos, estoque", "codped = '$codpedselect' AND pedidoprodtemp.codprod=produtos.codprod AND produtos.codprod=estoque.codprod and estoque.codemp='$codempselect'", $array1, $array_campo1, "");
