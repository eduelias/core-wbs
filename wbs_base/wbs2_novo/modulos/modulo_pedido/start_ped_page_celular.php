...
$prod->clear();
$prod->listProdU("pedidotemp.codemp, pedidotemp.codvend, tipo, fatorusertabela, fatorusertabela_cel","pedidotemp, vendedor", "codped='$codpedselect' AND pedidotemp.codvend=vendedor.codvend");
$codempselect = $prod->showcampo0();
$codvendselect = $prod->showcampo1();;
$tipovend = $prod->showcampo2();
$fatorusertabela = $prod->showcampo3();
$fatorusertabela_cel = $prod->showcampo4();

$fatorusertabela = $fatorusertabela_cel;

// Rotina Default


$prod->listProdSum("codcat, nomecat", "categoria", "(codcat = 46 or codcat = 71)", $array_pesq, $array_campo_pesq, "ORDER BY nomecat");
...
switch ($Action)
{
	...
	if ($palavrachave <> ""){
		...
		$condicao2 .= " AND (produtos.codcat = 46 or produtos.codcat = 71)";
	}
...
if ($condicao2 <> ""){
	...
	// TEMPLATE
	include ("templates/ped_page_celular.htm");
