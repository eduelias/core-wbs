...
#echo("codcli = $codcliente");
	...
	$prod->clear();
	$prod->listProdU("cep, endereco, numero, complemento, bairro, cidade, estado", "clientenovo", "codcliente=$codcliente");
...
if ($formapg[$i] =='02.00'){$dindim = $dindim*1;}else{$dindim = $dindim*0;}
		...
		$condicao_ped .= "modelo_ped = 'ATA', "; // TIPO DE PEDIDO ATA = ATACADO
