...
if ($condicao2 <> ""){
		...
		// LISTA OS REGISTROS
	$prod->listProdSum("produtos.codcat, produtos.codsubcat, produtos.codprod, SUM(qtde-reserva) as est, lib_linha, descres, nomeprod, (pvacj*1*$fatorusertabela_ata), (pva*1*$fatorusertabela_ata), (pvvcj*fatorvar*$fatorusertabela),(pvv*fatorvar*$fatorusertabela), restricao_pl, n_prod_int, n_prod_ext, nomecat, nomesubcat, ordem, cor1_prod, cor2_prod, reserva, produtos.gar_um, produtos.gar_cj, garext_12, garext_24, pvd, pvdcj ", "produtos, estoque, categoria, subcategoria", $condicao2 , $array2, $array_campo2, "GROUP BY produtos.codprod ORDER BY  nomecat, nomesubcat, nomeprod");
