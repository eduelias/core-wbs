...
for ($j = 0; $j < count($array1); $j++)
{
	...
	if ($pvdcj_real == 0){$preco_dist_real = $pvd_real;}else{$preco_dist_real = $pvdcj_real;}
	...
	if ($tipovend == "A" or $tipovend == "R"){
	   	if ($tipoprod_real == "CJ"){$preco_real = $preco_dist_real;}else{$preco_real = $preco_dist_real;}
	}else{
