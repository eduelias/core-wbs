...
$prod = new operacao();
 ...
 #echo "cidade =".$cidade_cli;
 $prod->clear();
 $prod->listProdU("COUNT(*)", "clientenovo", "cidade like '$cidade_cli' and tipocliente = 'F'");
 
 $rand = rand(0,$prod->showcampo0());
 
 $prod->clear();
 $prod->listProdU("cpf", "clientenovo", "cidade like '$cidade_cli' and tipocliente = 'F' LIMIT $rand,1");
 $frmCPF = $prod->showcampo0();
 #$Action = "Procurar";
 echo $Action;
 $tipogravar = "UPDATE";
    ...
    case "Gravar" :
        ...
        if (($codcliente == "" or $tipogravar == "UPDATE") and $block_cpf <> 1) {
            ...
            if ($tipogravar == "UPDATE")
            {
                ...
                // Insere Novo
                // Operacao de Caixa
        	$opcaixaf = "02.00:02.01:02.17:02.18:02.30:02.31:02.32:02.33:02.34:02.40:02.42:02.43:02.46:02.47:02.49:02.50:02.51:02.53:02.54:02.55:02.56:02.35:02.36";
