...
switch ($Action)
{
	...
	default:
		...
		if ($var_codvend == 542 or $var_codvend == 543){$cond_emp = "codemp = 14";}else{$cond_emp = "codemp = 15";}
	
		$prod->listProdSum("codemp, nome", "empresa", $cond_emp, $arrayemp, $arrayemp_campo, "ORDER BY nome");
