...
$prod = new operacao();
	...
	if ($tipo_p == 7){$fatorfin = 1.006;}
	if ($tipo_p == 14){$fatorfin = 1.01;}
	if ($tipo_p == 28){$fatorfin = 1.024;}
	if ($tipo_p == 21){$fatorfin = 1.015;$nump=3;$tipo_p=14;}
	if ($tipo_p == 60){$fatorfin = 1.06;}
	...
	// CALCULO DA COMISSAO
		...
		#$mlb = $valorvendavista - $valorcustovista - $impostodif;
			...
			#$mlb = (($valortabela_realvista)-$valorvendavista)/(2*$fatorfin) + (($valortabela_realvista*$fatorusertabela_ata)-$valorcustovista)/$fatorfin;
			#$mlb = ($valorvendavista-($valortabela_realvista))/(2*$fatorfin) + (($valortabela_realvista*$fatorusertabela_ata)-$valorcustovista)/$fatorfin;
		#}else{
			#$mlb = ($valortabela_realvista*$fatorusertabela_ata-$valorcustovista)/$fatorfin;
