...
switch ($Action)
{
	...
	default:
		...
		for($i = 0; $i < count($arrayemp); $i++ ){
		 ...
		 $prod->clear();
		$prod->listProdSum("codvend_user, login_user","vendedor_usuario", "hist <> 'Y' and codvend = $var_codvend and tipo_supervisor = 'S'", $array6, $array_campo6 , "order by login_user");
