...
FROM clientenovo_cobranca WHERE codcar =fin_car.codcar  ) as num_contato, (SELECT DATE_FORMAT(data_agenda, '%d-%m-%Y' )
FROM clientenovo_cobranca WHERE codcar =fin_car.codcar ORDER by codvisita DESC limit 1) as data_visita,  (select dataped from pedido where codped = fin_car.codped) as dataped FROM fin_car WHERE valorpago = 0  and hist = 'N' and (codcliente = '$codcliente_pesq' ".$cond." ) and (opcaixa = '02.04' or opcaixa = '02.03')  ORDER BY datavenc ","SQL_NONE","N");
...
*/
        ...
        include ("templates/relatorio_page_cobranca_detalhes.html");
