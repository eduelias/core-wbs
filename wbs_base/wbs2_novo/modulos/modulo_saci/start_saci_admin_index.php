...
switch ($Action)
{
    ...
    case "Gravar" :
        ...
        echo ("<b>controledata -></b> $controledata<br>");
    ...
    case "Editar" :
        ...
        #echo "status:$status histcond: $histcond<br>";
        if ($alt_motivo == "S") {
        ...
        #echo "campo10: $campo10<br>";
        $prod->setcampo10($campo10);
        $prod->addProd("saci_atend_status", $uregatendstatus);
        
        #echo ("<b>condicaopesq -></b> $condicaopesq<br>");
...
#echo ("<b>condicaopesq -></b> $condicaopesq<br>");
#echo ("<b>dtagenda -></b> $dtagenda<br>");

$prod->clear();
$prod->listProdSum("codatend, saci_atend.codcliente, dtatendinicio, dtagenda, hratend, solucaostatus, tipo, status, humor, retorno", "saci_atend, clientenovo", "$condicaopesq clientenovo.codcliente = saci_atend.codcliente", $arrayx, $array_campox, "ORDER BY codatend DESC LIMIT 0,50");
...
include ("templates/saci_admin_index.htm");
