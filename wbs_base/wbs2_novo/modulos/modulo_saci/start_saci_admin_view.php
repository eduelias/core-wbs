...
// categoria
$prod->clear();
$prod->listProdSum("saci_cat.idcat, saci_cat.titulo", "saci_cat", "saci_cat.habilitado = 'S'", $arrayx, $array_campox, "ORDER BY saci_cat.titulo");
...
// HIST N ou S
if ($hist_view == "N") {
    include ("templates/saci_admin_edit.htm");
}
if ($hist_view == "S") {
    include ("templates/saci_admin_view.htm");
}
