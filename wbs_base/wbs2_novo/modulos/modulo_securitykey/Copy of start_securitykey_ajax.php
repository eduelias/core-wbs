...
if($autoriza == 1)
{
	...
	echo "<script type=\"text/javascript\">var check_autoriza = $autoriza;</script><span id=\"autoriza_ok\">Autenticado!</span><meta http-equiv=\"Refresh\" content=\"1;URL=#\" />";
}
else
{
	$_SESSION['secure_ch'][$pg_go][$pg_ped_go] = false;
	echo "<script type=\"text/javascript\">var check_autoriza = $autoriza;</script><span id=\"autoriza_no\">Senha incorreta, tente novamente!</span>";
}
