...
<div class="container">
    ...
    <div class="secao">CLIENTE</div>
        <div class="form">
        <?php include('modulos/mod_pedido/pedido_rapido/cliente.php');?>
        </div>
    </div>
    <br />
<div id="produtos" style="display:none">
        ...
        <div class="secao">PRODUTOS</div>
            <div class="form">
            <?php include('modulos/mod_pedido/pedido_rapido/produtos.php'); ?>
            </div>
        </div>  
    ...
    <div class="secao">PAGAMENTO</div>
        <div class="form">
            <?php include('modulos/mod_pedido/pedido_rapido/pagamento.php'); ?>
        </div>
    </div>
</div>