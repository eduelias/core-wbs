...
YAHOO.util.Event.addListener(window, "load", function() {
	...
	//CASO O PRODUTO SEJA CONTROLADO POR NUMERO DE SERIE, UTILZIA ESSA FUN���AO PARA ENCONTRA-LO/VALIDA-LO
	YAHOO.util.Event.addListener(sn, "blur", function(e, oSelf) {
		...
		var file = '<?=encode('modulos/mod_pedido/pedido_rapido/ajax_produtos.php')?>';
		
		//ATEN���AO, EM CASO DE SERIAL NUMBER TESTAR PARA VER SE O MESMO JA NAO EST��� NO MESMO PEDIDO
	...
	//BUSCA SE O PRODUTO ��� CONTROLADO POR SERIAL NUMBER. USA APENAS O EAN13
		...
		_hand = {
			success:function(o){
				...
				switch (true) {
					...
					//caso o dito produto seja controlado por n���mero de s���rie
					case (!eval(resp.ean)):{
