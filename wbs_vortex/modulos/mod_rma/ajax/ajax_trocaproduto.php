...
<?
echo '<form onSubmit="return WBS.sendForm(this);" action="modulos/formularios/act.php" method="post">';
...
<script>
	...
	YAHOO.util.Event.addListener(btroca, "click", function(e, oSelf) {
		...
		var cObj = YAHOO.util.Connect.asyncRequest('get', encodeURI('ajax_html.php?file="<?=encode('modulos/mod_rma/sub_adm/ajax_nomeporcodprod.php')?>"&codprod='+codprod.value+'&codemp='+empresa), _hand);
