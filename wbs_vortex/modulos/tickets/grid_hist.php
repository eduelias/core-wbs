<?
	//Cria a página
	$pagina = new pagina("tickets_hist","Sistema de Tickets");

	//Seta o elemento grid na página
	$pagina->setGrid("idticket,status,data_aberto,msg,(select data from v_ticket_status where idticket = v_tickets.idticket ORDER by data DESC limit 1) as data_final","v_tickets", "codvend=".$_SESSION['id']." AND status >= 4", "Lista de tickets","idticket","v_tickets","",'1600');
